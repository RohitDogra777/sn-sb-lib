...
function loadWebComponents() {
  ...
  if (document.querySelector("ods-avatar")) {
    import('https://cdn.jsdelivr.net/gh/RohitDogra777/sn-sb-lib@v3.0.1/chunks/Avatar-LNIklOIX.js').then(function () {
  ...
  if (document.querySelector("ods-heading")) {
    import('https://cdn.jsdelivr.net/gh/RohitDogra777/sn-sb-lib@v3.0.1/chunks/Heading-wKT0e24g.js').then(function () {
  ...
  if (document.querySelector("ods-text")) {
    import('https://cdn.jsdelivr.net/gh/RohitDogra777/sn-sb-lib@v3.0.1/chunks/Text-C6-S6tLh.js').then(function () {
  ...
  if (document.querySelector("ods-icon")) {
    import('https://cdn.jsdelivr.net/gh/RohitDogra777/sn-sb-lib@v3.0.1/chunks/Icon-CjWNPvlv.js').then(function () {
  ...
  if (document.querySelector("ods-button")) {
    import('https://cdn.jsdelivr.net/gh/RohitDogra777/sn-sb-lib@v3.0.1/chunks/Button-2nPJ1Pk3.js').then(function () {
  ...
  if (document.querySelector("ods-container")) {
    import('https://cdn.jsdelivr.net/gh/RohitDogra777/sn-sb-lib@v3.0.1/chunks/Container-C_Co7DJ7.js').then(function () {
