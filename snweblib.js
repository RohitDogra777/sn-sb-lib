    ...
    _createClass(SnWcHeading, [{
      ...
      value: function getHeading(surface) {
        ...
        if (this['heading-level'] == "1") {
          return x(_templateObject || (_templateObject = _taggedTemplateLiteral(["<h1 class=", " >", "</h1>"])), ["sn-wc-heading", mode].join(' '), this.label);
        }
        if (this['heading-level'] == "2") {
          return x(_templateObject2 || (_templateObject2 = _taggedTemplateLiteral(["<h2 class=", ">", "</h2>"])), ["sn-wc-heading", mode].join(' '), this.label);
        }
        if (this['heading-level'] == "3") {
          return x(_templateObject3 || (_templateObject3 = _taggedTemplateLiteral(["<h3 class=", ">", "</h3>"])), ["sn-wc-heading", mode].join(' '), this.label);
        }
        if (this['heading-level'] == "4") {
          return x(_templateObject4 || (_templateObject4 = _taggedTemplateLiteral(["<h4 class=", ">", "</h4>"])), ["sn-wc-heading", mode].join(' '), this.label);
        }
        if (this['heading-level'] == "5") {
          return x(_templateObject5 || (_templateObject5 = _taggedTemplateLiteral(["<h5 class=", ">", "</h5>"])), ["sn-wc-heading", mode].join(' '), this.label);
        }
        if (this['heading-level'] == "6") {
          return x(_templateObject6 || (_templateObject6 = _taggedTemplateLiteral(["<h6 class=", ">", "</h6>"])), ["sn-wc-heading", mode].join(' '), this.label);
        }
        return x(_templateObject7 || (_templateObject7 = _taggedTemplateLiteral(["<h1 class=", ">", "</h1>"])), ["sn-wc-heading", mode].join(' '), this.label);
      }
    }, {
      key: "render",
      value: function render() {
