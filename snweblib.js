    ...
    _createClass(SnWcLink, [{
      ...
      value: function getAnchorTag() {
        ...
        if (this.type === "Outline" || this.type === "Solid") {
          ...
          return x(_templateObject$2 || (_templateObject$2 = _taggedTemplateLiteral(["<button type=\"button\" part=\"sn-wc-link\"\n        class=", "\n        @click=\"", "\"\n      >\n        ", "\n      </button>"])), [btnClass, size, "btn-spacing"].join(" "), this.onClick, this.label);
        } else {
