(function (factory) {
   ...
   var primary = "--ods-sem-color-roles-primary";
   var odsAliases = {
      "text-primary": "--ods-sem-color-text-primary",
      "text-secondary": "--ods-sem-color-text-secondary",
      "text-tertiary": "--ods-sem-color-text-tertiary",
      "text-inverse": "--ods-sem-color-text-inverse",
      "icon-primary": "--ods-sem-color-icon-primary",
      "icon-secondary": "--ods-sem-color-icon-secondary",
      "icon-tertiary": "--ods-sem-color-icon-tertiary",
      "icon-inverse": "--ods-sem-color-icon-inverse",
      "border-primary": "--ods-sem-color-border-decorative-primary",
      "border-secondary": "--ods-sem-color-border-decorative-secondary",
      "border-interactive": "--ods-sem-color-border-interactive-component",
      "status-error": "--ods-sem-color-status-roles-error",
      "status-on-error": "--ods-sem-color-status-roles-error-on-error",
      "status-error-container": "--ods-sem-color-status-roles-error-error-container",
      "status-error-on-container": "--ods-sem-color-status-roles-error-on-error-container",
      "status-warning": "--ods-sem-color-status-roles-warning",
      "status-on-warning": "--ods-sem-color-status-roles-warning-on-warning",
      "status-warning-container": "--ods-sem-color-status-roles-warning-warning-container",
      "status-on-warning-container": "--ods-sem-color-status-roles-warning-on-warning-container",
      "status-success": "--ods-sem-color-status-roles-success",
      "status-on-success": "--ods-sem-color-status-roles-success-on-success",
      "status-success-container": "--ods-sem-color-status-roles-success-success-container",
      "status-on-success-container": "--ods-sem-color-status-roles-success-on-success-container",
      "status-info": "--ods-sem-color-status-roles-info",
      "status-on-info": "--ods-sem-color-status-roles-info-on-info",
      "status-info-container": "--ods-sem-color-status-roles-info-info-container",
      "status-on-info-container": "--ods-sem-color-status-roles-info-on-info-container",
      primary: primary,
      "role-primary": "--ods-sem-color-roles-primary",
      "role-on-primary": "--ods-sem-color-roles-primary-on-primary",
      "role-primary-container": "--ods-sem-color-roles-primary-primary-container",
      "role-on-primary-container": "--ods-sem-color-roles-primary-on-primary-container",
      "role-secondary": "--ods-sem-color-roles-secondary",
      "role-on-secondary": "--ods-sem-color-roles-secondary-on-secondary",
      "role-secondary-container": "--ods-sem-color-roles-secondary-container",
      "role-on-secondary-container": "--ods-sem-color-roles-secondary-on-secondary-container",
      "role-neutral": "--ods-sem-color-roles-neutral",
      "role-on-neutral": "--ods-sem-color-roles-neutral-on-neutral",
      "role-neutral-container": "--ods-sem-color-roles-neutral-container",
      "role-on-neutral-container": "--ods-sem-color-roles-neutral-on-neutral-container",
      "role-accent": "--ods-sem-color-roles-accent",
      "role-on-accent": "--ods-sem-color-roles-accent-on-accent",
      "role-accent-container": "--ods-sem-color-roles-accent-accent-container",
      "role-on-accent-container": "--ods-sem-color-roles-accent-on-accent-container",
      "background-primary": "--ods-sem-color-background-primary",
      "background-secondary": "--ods-sem-color-background-secondary",
      "background-tertiary": "--ods-sem-color-background-tertiary",
      "background-reverse-primary": "--ods-sem-color-background-reverse-primary",
      "background-reverse-secondary": "--ods-sem-color-background-reverse-secondary",
      "background-reverse-tertiary": "--ods-sem-color-background-reverse-tertiary"
   };
   ...
   var OdsIcon = /*#__PURE__*/function (_LitElement) {
     ...
     return _createClass(OdsIcon, [{
       key: "render",
       value: function render() {
         var alias = odsAliases[this.color];
         var svg = 'x_snc_ods.' + this["icon-name"] + '.svg';
         return x(_templateObject$n || (_templateObject$n = _taggedTemplateLiteral(["\n        <style>\n        :host{\n          display: inline-flex;\n        }\n        .ods-icon{\n            display: inline-flex;\n            background-color: var(", ");\n            background-color: ", ";\n            -webkit-mask: url(", ") no-repeat center;\n            mask: url(", ") no-repeat center;\n            mask-size: 100%;\n        }\n        .ods-icon--sm{\n          height: var(--ods-sem-icon-sm);\n          width:  var(--ods-sem-icon-sm);\n        }\n        .ods-icon--md{\n          height: var(--ods-sem-icon-md);\n          width:  var(--ods-sem-icon-md);\n        }\n        .ods-icon--lg{\n          height: var(--ods-sem-icon-lg);\n          width:  var(--ods-sem-icon-lg);    \n        }\n        </style>\n        <div part=\"odsIcon\" class=\"ods-icon ods-icon--", "\"></div>\n        "])), alias, this.color && this.color !== "" && this.color !== "undefined" ? this.color : "var(--ods-sem-color-text-primary)", svg, svg, this["icon-size"].toLocaleLowerCase());
       }
     }]);
   }(s$2);
   ...
   var _templateObject$m, _templateObject2$h, _templateObject3$f, _templateObject4$c, _templateObject5$8;
   ...
   var ODSAvatar = /*#__PURE__*/function (_LitElement) {
     ...
     return _createClass(ODSAvatar, [{
       ...
       value: function getAvatarContent() {
         var size = "".concat(this["avatar-size"]);
         size = size.toLowerCase();
         if (this.image && this.image != "") {
           return x(_templateObject$m || (_templateObject$m = _taggedTemplateLiteral(["\n        <img\n          class=", "\n          src=\"", "\"\n          alt=\"Avatar Image\"\n          aria-label=\"Image\"\n        />\n      "])), ["ods-avatar", "ods-avatar-" + size].join(" "), this.image);
         } else if (this.icon && this.icon != "") {
           return x(_templateObject2$h || (_templateObject2$h = _taggedTemplateLiteral(["\n        <div\n          class=", "\n          aria-label=\"Icon\"\n        >\n          <ods-icon icon-name=\"", "\" color=\"white\"></ods-icon>\n        </div>\n      "])), ["ods-avatar", "ods-avatar-" + size].join(" "), this.icon);
         } else if (this.username && this.username != "") {
           return x(_templateObject3$f || (_templateObject3$f = _taggedTemplateLiteral(["\n        <div\n          class=", "\n          aria-label=\"", "\"\n        >\n          ", "\n        </div>\n      "])), ["ods-avatar", "ods-avatar-" + size].join(" "), this.username, this.getAvatarText());
         }
         return x(_templateObject4$c || (_templateObject4$c = _taggedTemplateLiteral(["\n      <div\n        class=", "\n        aria-label=\"Anonymous\"\n      >\n        <ods-icon icon-name=\"user\" color=\"white\"></ods-icon>\n      </div>\n    "])), ["ods-avatar", "ods-avatar-" + size].join(" "));
       }
     }, {
       key: "render",
       value: function render() {
         ...
         return x(_templateObject5$8 || (_templateObject5$8 = _taggedTemplateLiteral(["\n      <style>\n        * {\n          margin: var(--ods-sem-space-none);\n          padding: var(--ods-sem-space-none);\n          box-sizing: border-box;\n        }\n        .ods-avatar-xxl {\n          width: var(--ods-sem-avatar-size-xxl);\n          height: var(--ods-sem-avatar-size-xxl);\n          font-size: var(--ods-sem-avatar-font-size-xxl);\n        }\n        .ods-avatar-xl {\n          width: var(--ods-sem-avatar-size-xl);\n          height: var(--ods-sem-avatar-size-xl);\n          font-size: var(--ods-sem-avatar-font-size-xl);\n        }\n        .ods-avatar-lg {\n          width: var(--ods-sem-avatar-size-lg);\n          height: var(--ods-sem-avatar-size-lg);\n          font-size: var(--ods-sem-avatar-font-size-lg);\n        }\n        .ods-avatar-md {\n          width: var(--ods-sem-avatar-size-md);\n          height: var(--ods-sem-avatar-size-md);\n          font-size: var(--ods-sem-avatar-font-size-md);\n        }\n        .ods-avatar-sm {\n          width: var(--ods-sem-avatar-size-sm);\n          height: var(--ods-sem-avatar-size-sm);\n          font-size: var(--ods-sem-avatar-font-size-sm);\n        }\n        .ods-avatar {\n          position: relative;\n          display: inline-flex;\n          align-items: center;\n          justify-content: center;\n          vertical-align: middle;\n          border-radius: var(--ods-sem-radius-full);\n          transition: margin 0.15s;\n          --cui-bg-opacity: 1;\n          background-color: var(--ods-sem-color-roles-secondary);\n          color: var(--ods-sem-color-roles-primary-on-primary);\n          text-transform: uppercase;\n          font-family: var(--ods-sem-font-family-gilroy-md);\n          font-weight: var(--ods-sem-font-weight-600);\n          object-fit: cover;\n        }\n        ods-icon::part(odsIcon) {\n          height: ", ";\n          width: ", ";\n          display: flex;\n        }\n      </style>\n      ", "\n    "])), iconDimension, iconDimension, this.getAvatarContent());
       }
     }], [{
       key: "properties",
       get: function get() {
   ...
   var _templateObject$l, _templateObject2$g, _templateObject3$e, _templateObject4$b, _templateObject5$7, _templateObject6$7, _templateObject7$5, _templateObject8$2;
   ...
   var OdsButton = /*#__PURE__*/function (_LitElement) {
     function OdsButton() {
       ...
       _this["is-disabled"] = "false";
       _this["icon-position"] = 'start';
       _this.target = '_self';
     ...
     return _createClass(OdsButton, [{
       ...
       value: function getIcon() {
         ...
         var color = (colorMap[this.variant] || {}).hasOwnProperty(this["is-disabled"]) ? colorMap[this.variant][this["is-disabled"]] : "#515151";
         return x(_templateObject$l || (_templateObject$l = _taggedTemplateLiteral(["\n  <ods-icon icon-size=\"sm\" icon-name=\"", "\" color=\"", "\"/>\n  "])), icon || 'placeholder', color);
       }
     }, {
       key: "getButton",
       value: function getButton() {
         var iconPosition = this.variant === 'ghost' && !this["icon-position"] ? 'end' : this["icon-position"];
         var iconLeft = iconPosition === 'start' ? this.getIcon() : '';
         var iconRight = iconPosition === 'end' ? this.getIcon() : '';
         var fullwidth = this["full-width"] == 'true' ? 'full-width' : '';
         var tabindex = this["is-disabled"] == 'true' ? -1 : 0;
         if (this.url) {
           return x(_templateObject2$g || (_templateObject2$g = _taggedTemplateLiteral(["\n      <a class=' btn-", " ", " ", "' href= \"", "\" target=\"", "\" tabindex= \"", "\" aria-disabled = \"", "\" >\n      ", " \n      <slot> </slot>\n      ", "\n      </a>\n      "])), this.variant || 'outline', this["is-disabled"] == 'true' ? "disabled-".concat(this.variant) : '', fullwidth, this.url, this["new-tab"] == 'true' ? '_blank' : '_self', tabindex, this["is-disabled"] ? 'true' : 'false', iconLeft ? x(_templateObject3$e || (_templateObject3$e = _taggedTemplateLiteral(["<i class= 'icon-left'> ", " </i>"])), iconLeft) : '', iconRight ? x(_templateObject4$b || (_templateObject4$b = _taggedTemplateLiteral(["<i class= 'icon-right'> ", " </i>"])), iconRight) : '');
         } else {
           return x(_templateObject5$7 || (_templateObject5$7 = _taggedTemplateLiteral(["\n        <button @click=\"", "\" tabindex= \"", "\" class='btn-", " ", " ", "' aria-disabled = \"", "\" >\n      ", " \n      <slot> </slot>\n      ", "\n      </button>\n      "])), this.onClick, tabindex, this.variant || 'outline', this["is-disabled"] == 'true' ? "disabled-".concat(this.variant) : '', fullwidth, this["is-disabled"] ? 'true' : 'false', iconLeft ? x(_templateObject6$7 || (_templateObject6$7 = _taggedTemplateLiteral(["<i class= 'icon-left'> ", " </i>"])), iconLeft) : '', iconRight ? x(_templateObject7$5 || (_templateObject7$5 = _taggedTemplateLiteral(["<i class= 'icon-right'> ", " </i>"])), iconRight) : '');
         }
       }
       ...
       key: "render",
       value: function render() {
         return x(_templateObject8$2 || (_templateObject8$2 = _taggedTemplateLiteral(["\n\n    <style>\n    :host{\n      display: ", ";\n    }\n    \n    a, button {\n        font-family:'Lato', Helvetica, Arial, sans-serif;\n        font-size: 16px;\n        text-decoration: none;\n        font-style: normal;\n        font-weight: 700;\n        line-height: var(--ods-sem-space-lg);\n        border: var(--ods-sem-space-none);\n        border-radius: var( --ods-sem-space-sm);\n        cursor: pointer;\n        display: inline-flex;\n        justify-content: center;\n        padding: 10px var(--ods-sem-space-lg);\n        box-sizing: border-box;\n    }\n\n    .full-width {\n      width: 100%;\n    }\n\n    .button-container{\n       border-radius: var( --ods-sem-space-sm);\n    }\n\n    .btn-solid {\n        color: var(--ods-sem-color-roles-primary-on-primary);\n        background-color: var(--ods-sem-color-roles-primary);\n    }\n\n    .btn-solid:hover {\n      background-color: var(--ods-sem-color-utility-states-primary-on-color-hover);\n    }\n\n    .btn-solid:active, [active-menu] {\n      background-color: var(--ods-sem-color-utility-states-primary-on-color-pressed);\n    }\n\n    .btn-outline {\n        color: var(--ods-sem-color-roles-primary);\n        background-color: var(--ods-sem-color-roles-primary-on-primary) ;\n        box-shadow:0 0 0 1px;\n    }\n\n    .btn-outline:hover {\n      background: var(--ods-sem-color-utility-states-primary-hover);\n    }\n\n    .btn-outline:active, [active-menu]{\n      background: var(--ods-sem-color-utility-states-primary-pressed);\n    }\n           \n    .btn-destructive-solid {\n        color: var(--ods-sem-color-status-roles-error-on-error);\n        background-color: var(--ods-sem-color-status-roles-error);\n    }\n\n    .btn-destructive-solid:hover {\n        background-color: var(--ods-sem-color-utility-states-error-on-color-hover);\n    }\n\n    .btn-destructive-solid:active, [active-menu]{\n        background-color: var(--ods-sem-color-utility-states-error-on-color-pressed);\n    }\n              \n    .btn-destructive-outline {\n        color: var(--ods-sem-color-status-roles-error);\n        background-color: var(--ods-sem-color-status-roles-error-on-error);\n        box-shadow:0 0 0 1px ;\n    }\n\n    .btn-destructive-outline:hover {\n      background-color: var(--ods-sem-color-utility-states-error-hover);\n    }\n\n    .btn-destructive-outline:active, [active-menu]{\n      background-color: var(--ods-sem-color-utility-states-error-pressed);\n    }\n\n    :host(:focus-within) .btn-solid, :host(:focus-within) .btn-destructive-solid {\n      outline: none;\n      box-shadow: 0 0 0 2px var(--ods-sem-color-roles-primary-on-primary), 0 0 0 var(--ods-sem-space-xs) var(--ods-sem-color-utility-states-focus);\n    }\n\n    :host(:focus-within) .btn-outline{\n     outline: none;\n     box-shadow: 0 0 0 1px var(--ods-sem-color-utility-states-focus), 0 0 0 3px var(--ods-sem-color-roles-primary-on-primary), 0 0 0 5px var(--ods-sem-color-utility-states-focus);\n    }\n    :host(:focus-within) .btn-destructive-outline {\n     outline: none;\n     box-shadow: 0 0 0 1px var(--ods-sem-color-status-roles-error), 0 0 0 3px var(--ods-sem-color-status-roles-error-on-error), 0 0 0 5px var(--ods-sem-color-utility-states-focus);\n    }\n\n    .btn-ghost {\n    padding: var(--ods-sem-space-sm) var( --ods-sem-space-none);\n    border-radius:  var(--ods-sem-space-sm);\n    color: var(--ods-sem-color-roles-primary);\n    background: transparent;\n    }\n\n    .btn-ghost:hover {\n    background: var(--ods-sem-color-utility-states-primary-hover);\n    }\n\n    .btn-ghost:active, [active-menu]{\n    background: var(--ods-sem-color-utility-states-primary-pressed);\n    }\n\n    :host(:focus-within) .btn-ghost{\n      outline: none;\n      box-shadow: 0 0 0 2px var(--ods-sem-color-utility-states-focus);\n    }\n\n\n    .disabled-solid , .disabled-solid:hover, .disabled-solid:focus, .disabled-destructive-solid,  .disabled-destructive-solid:hover, .disabled-destructive-solid:focus {\n      color: var(--ods-sem-color-utility-states-disabled-content);\n      background: var(--ods-sem-color-utility-states-disabled-container);\n      opacity: 0.5;\n      cursor: not-allowed;\n      pointer-events: none;\n      box-shadow: 0 0 0 0 var(--ods-sem-color-utility-transparent) !important;\n    }\n\n    .disabled-outline, .disabled-outline:hover, .disabled-outline:focus, .disabled-destructive-outline,  .disabled-destructive-outline:hover, .disabled-destructive-outline:focus  {\n      color: var(--ods-sem-color-utility-states-disabled-content);\n      background: var(--ods-sem-color-utility-states-disabled-container);\n      opacity: 0.5;\n      box-shadow: 0 0 0 1px !important;\n      cursor: not-allowed;\n      pointer-events: none;\n    }\n\n    .disabled-ghost, .disabled-ghost:hover, .disabled-ghost:focus{\n      border-radius: var(--ods-sem-space-sm);\n      color: var(--ods-sem-color-utility-states-disabled-content);\n      opacity: 0.5;\n      cursor: not-allowed;\n      pointer-events: none;\n      background: transparent;\n      box-shadow: 0 0 0 0 var(--ods-sem-color-utility-transparent) !important;\n    }\n\n    .icon-left{\n        display: inline-flex;\n    \n    ods-icon::part(odsIcon){\n      height: var(--ods-sem-space-md);\n      width: var(--ods-sem-space-md);\n      margin-right: var(--ods-sem-space-sm);\n      vertical-align: baseline;\n      margin-top: var(--ods-sem-space-xs);\n      \n        }\n    }   \n\n    .icon-right{\n      display: inline-flex;\n\n    ods-icon::part(odsIcon) {\n      height: var(--ods-sem-space-md);\n      width: var(--ods-sem-space-md);\n      margin-left: var(--ods-sem-space-sm);\n      vertical-align: baseline;\n      margin-top: var(--ods-sem-space-xs);\n     \n        }\n    }   \n\n    .button-container:has(.disabled-solid, .disabled-destructive-solid, .disabled-outline, .disabled-destructive-outline, .disabled-ghost){\n      cursor: not-allowed;\n      }\n\n    </style>\n    <div class=\"button-container\">", "\n    </div>\n      "])), this["full-width"] == 'true' ? 'block' : 'inline-flex', this.getButton());
       }
     }], [{
       key: "properties",
       get: function get() {
   ...
   var _templateObject$k, _templateObject2$f, _templateObject3$d;
   /**
    * Service Now ODS Chip Component
    * @input disabled, url, target
   ...
   var OdsChip = /*#__PURE__*/function (_LitElement) {
     ...
     return _createClass(OdsChip, [{
       ...
       value: function getChip() {
         var tabindex = this["is-disabled"] == 'true' ? -1 : 0;
         if (this.url) {
           return x(_templateObject$k || (_templateObject$k = _taggedTemplateLiteral(["\n      <a @click=", " class='ods-chip ", "' href= \"", "\" target=\"", "\" tabindex= \"", "\" aria-disabled = \"", "\">\n      <slot name=\"start\"></slot>\n      <slot name=\"label\"></slot>\n      <slot name=\"end\"></slot>\n      </a>\n      "])), this.stateFocus, this["is-disabled"] == 'true' ? 'disabled' : '', this.url, this["new-tab"] == 'true' ? '_blank' : '_self', tabindex, this["is-disabled"] == 'true' ? 'true' : 'false');
         } else {
           return x(_templateObject2$f || (_templateObject2$f = _taggedTemplateLiteral(["\n      <button @click=", " class='ods-chip ", "' tabindex= \"", "\" aria-disabled = \"", "\">\n      <slot name=\"start\"></slot>\n      <slot name=\"label\"></slot>\n      <slot name=\"end\"></slot>\n      </button>\n      "])), this.clickValidation, this["is-disabled"] == 'true' ? 'disabled' : '', tabindex, this["is-disabled"] == 'true' ? 'true' : 'false');
         }
       }
     }, {
       key: "render",
       value: function render() {
         return x(_templateObject3$d || (_templateObject3$d = _taggedTemplateLiteral(["\n  \n    <style>\n    :host{\n      display: inline-flex;\n    }\n\n    .ods-chip{\n        border-radius: var(--ods-sem-radius-full);\n        text-decoration: none;\n        background: var(--ods-sem-color-roles-primary-on-primary);\n        cursor: pointer;\n        justify-content: center;\n        box-sizing: border-box;\n        display: inline-flex;\n        align-items: center;\n        padding: var(--ods-sem-radius-sm) var(--ods-sem-space-md) var(--ods-sem-radius-sm) var(--ods-sem-radius-sm);\n        outline:1px solid var(--ods-sem-color-border-interactive-component);\n        border: none;\n        gap: var(--ods-sem-space-sm);\n      }\n\n    .ods-chip.adjusted-padding{\n      padding: var(--ods-sem-radius-sm) var(--ods-sem-space-md);\n    }\n    \n    .ods-chip:hover {\n     background: var(--ods-sem-color-utility-states-secondary-hover);\n     border: none;\n     outline:1px solid color-mix(in srgb, var(--ods-sem-color-utility-states-secondary-hover), var(--ods-sem-color-border-interactive-component));\n    }\n\n    .ods-chip:active {\n     background: var(--ods-sem-color-utility-states-secondary-pressed);\n     border: none;\n     outline:1px solid color-mix(in srgb, var(--ods-sem-color-utility-states-secondary-pressed), var(--ods-sem-color-border-interactive-component));\n    }\n\n    .ods-chip:focus {\n        outline: 1px solid var(--ods-sem-color-utility-states-focus);\n        border: none;\n        box-shadow: 0 0 0 3px var(--ods-sem-color-roles-primary-on-primary), 0 0 0 5px var(--ods-sem-color-utility-states-focus);\n    }\n\n    .disabled {\n      color: var(--ods-sem-color-utility-states-disabled-content);\n      opacity: 0.5;\n      background: var(--ods-sem-color-utility-states-disabled-container);\n      cursor: not-allowed;\n      box-shadow:0 0 0 1px var(--ods-sem-color-border-interactive-component);\n      pointer-events: none;\n    }\n\n\n    .disabled::slotted(ods-icon){\n     color: var(--ods-sem-color-utility-states-disabled-content);\n    }\n\n    .chip-container:has(.disabled){\n      cursor: not-allowed;\n      }\n\n    </style>\n    <div class=\"chip-container\">", "\n    </div>\n      "])), this.getChip());
       }
     }], [{
       key: "properties",
       get: function get() {
   ...
   var OdsContainer = /*#__PURE__*/function (_LitElement) {
     ...
     return _createClass(OdsContainer, [{
       ...
       value: function render() {
         ...
         return x(_templateObject$j || (_templateObject$j = _taggedTemplateLiteral([" \n    <style>\n    .ods-container{\n      display: flex;\n      padding: var(--ods-sem-space-md);\n      flex-direction: column;\n      align-items: flex-start;\n      gap: var(--ods-sem-space-none);\n      border-radius: var(--ods-sem-radius-lg);\n      border: 1px solid var(--ods-sem-color-border-decorative-primary);\n      background: var(--ods-sem-color-roles-neutral-on-neutral);\n      word-break: break-word;\n    }\n    \n    .ods-container--padding-md{\n      padding: var(--ods-sem-space-md);\n    }\n    .ods-container--padding-lg{\n      padding: var(--ods-sem-space-lg);\n    }\n    .ods-container--padding-none{\n      padding: var(--ods-sem-space-none);\n      ::slotted(*) {\n        border-radius: var(--ods-sem-radius-lg);\n      }\n    }\n\n    .ods-container--shadow{\n      box-shadow: var(--ods-sem-shadow-sm-x) var(--ods-sem-shadow-sm-y) var(--ods-sem-shadow-sm-blur) var(--ods-sem-shadow-sm-spread) var(--ods-sem-shadow-color);\n    }\n    </style>\n    <div class=\"ods-container ods-container--padding-", " ", "\" part=\"odsContainer\">\n        <slot></slot>\n    </div>"])), padding, this.shadow == 'true' ? 'ods-container--shadow' : '');
       }
     }]);
   }(s$2);
    ...
    * Extract Arguments
    */
   function extractArguments(fnCallString) {
     var regex = /\((.*?)\)/;
     var match = fnCallString.match(regex);
     if (match && match[1]) {
   ...
   /**
    * Is it Scope Variable or something else
    */
   function getArgumentValues(ngScope, arr, event) {
     var newArg = [];
     for (var i = 0; i < arr.length; i++) {
       var val = getModel(ngScope, arr[i]);
       if (arr[i] == "$event") {
         newArg.push(event);
       } else if (getModel(ngScope, arr[i])) {
         newArg.push(val);
       } else {
         newArg.push(arr[i]);
       }
   ...
   /**Handle Controller Level Variables */
   function handleScope(obj, path, value) {
     var keys = path.split('.');
     var target = obj;
     ...
     return _createClass(OdsBridgeApi, [{
       ...
       value: function getNgAttributes() {
         try {
           ...
           if (this.checkNgCompatibility()) {
             ...
             if (this.elRef.getAttribute("ng-keyup")) {
               obj["ng-keyup"] = this.elRef.getAttribute("ng-keyup");
             }
           }
       ...
       value: function getNgScope() {
         try {
           ...
           var scope = null;
           var widgetScope = this.elRef.getAttribute("widget-scope");
           if (widgetScope) {
             scope = window[widgetScope];
           } else {
             scope = angular.element(this.elRef).scope();
           }
           return scope;
         } catch (err) {
           return null;
         ...
         if (this.checkNgCompatibility()) {
           try {
             ...
             if (ngScope && this.attributeNg["ng-model"]) {
               return getModel(ngScope, this.attributeNg["ng-model"]);
             }
             return "";
           } catch (err) {
             return "";
       ...
       key: "updateNgScope",
       value: function updateNgScope(ngScope, value, event) {
         var _this = this;
         ngScope.$applyAsync(function () {
           for (var obj in _this.attributeNg) {
             if (obj == "ng-model") {
               handleScope(ngScope, _this.attributeNg[obj], value);
             }
             if (obj == "ng-change" || obj == "ng-keyup" || obj == "ng-keydown") {
               var fnPath = getFnName(_this.attributeNg[obj]);
               var func = get(ngScope, fnPath);
               if (isFunction(func)) {
                 var fnArguments = extractArguments(_this.attributeNg[obj]);
                 if (fnArguments.length > 0) {
                   var actualArgs = getArgumentValues(ngScope, fnArguments, event);
                   func.apply(void 0, _toConsumableArray(actualArgs));
                 } else {
                   func();
                 }
               } else {
       ...
       key: "syncScopeProperty",
       value: function syncScopeProperty(controller, property, value) {
         try {
           var obj = {};
           if (this.checkNgCompatibility()) {
             var ngScope = this.getNgScope();
             ngScope.$applyAsync(function () {
               if (controller) ngScope[controller][property] = value;else ngScope[property] = value;
             });
           }
           return isObjEmpty(obj) ? null : obj;
         } catch (err) {
   ...
   var OdsDialog = /*#__PURE__*/function (_LitElement) {
     ...
     return _createClass(OdsDialog, [{
       ...
       value: function updated(changedProperties) {
         _get(_getPrototypeOf(OdsDialog.prototype), "updated", this).call(this);
         var oldOpen = changedProperties.get('is-open');
         if (oldOpen !== this["is-open"] && typeof oldOpen !== 'undefined') {
           this._checkButtons();
         }
       }
     }, {
       ...
       value: function _checkButtons() {
         ...
         if (assignedElements.length === 0) {
           ...
           (_this$shadowRoot$quer = this.shadowRoot.querySelector('.footer')) === null || _this$shadowRoot$quer === void 0 || _this$shadowRoot$quer.classList.toggle('hide');
           assignedElements = Array.from(this.querySelectorAll('[slot="footer"]'));
         }
         ...
         if (!hasButtons) {
           ...
           assignedElements.forEach(function (el) {
             if (el.tagName.toLowerCase() === 'ods-button' && el.hasAttribute('url')) {
       ...
       value: function render() {
         ...
         return x(_templateObject2$e || (_templateObject2$e = _taggedTemplateLiteral(["\n    <style>\n    :host {\n        display: block;\n      }\n      .scrim {\n        position: fixed;\n        top: 0;\n        left: 0;\n        width: 100%;\n        height: 100%;\n        background-color: var(--ods-sem-color-background-reverse-primary);\n        opacity: 0.75;\n        z-index:9998;\n      }\n      .modal-container{\n        position: fixed;\n        top: 0;\n        left: 0;\n        width: 100%;\n        height: 100%;\n        display: flex;\n        justify-content: center;\n        align-items: center;\n        z-index:9999;\n      }\n      .modal {\n        padding: var(--ods-sem-space-lg);\n        background: var(--ods-sem-color-roles-primary-on-primary);\n        border-radius: var(--ods-sem-space-sm);\n        max-width: ", ";\n        max-height: ", ";\n        width: 100%;\n        display: flex;\n        flex-direction: column;\n        ", "\n        margin: var(--ods-sem-space-lg);\n      }\n      \n      .header {\n        display: inline-flex;\n        justify-content: space-between;\n        align-items: center;\n        gap: var(--ods-sem-space-sm);\n        margin-bottom: var( --ods-sem-space-sm);\n        word-break: break-word;\n      }\n      \n      .icon-close{\n        align-self: flex-start;\n      }\n\n      .content {\n        ", "\n      }\n\n      .content::-webkit-scrollbar {\n        width: 10px;\n      }\n      \n      .content::-webkit-scrollbar-track {\n        background-color: #FFFFFF;\n        border-radius: var(--ods-sem-radius-full);\n      }\n      \n      .content::-webkit-scrollbar-thumb {\n        background-color: var(--ods-sem-color-border-decorative-primary);\n        border-radius: var(--ods-sem-radius-full);\n        height:30px;\n      }\n\n      .footer  {\n        gap: var(--ods-sem-space-sm);\n        margin-top: var(--ods-sem-space-xl);\n        display: flex;\n        justify-content: flex-end;\n        word-break: break-word;\n      }\n\n      \n\n      .modal.small-width .footer{\n        flex-direction: column-reverse;\n        align-items: stretch;\n      }\n\n      @media screen and (max-width: 479px){\n       .footer {\n        flex-direction: column-reverse;\n        align-items: stretch;\n        }\n        }\n\n      ods-heading{\n        padding: 6px 0px;\n      }\n      .hide  {\n        display:none !important;\n      }\n     \n    </style>\n      ", "\n    "])), maxWidth, this["max-height"], this.fixed == 'true' ? '' : 'overflow-y: auto;', this.fixed == 'true' ? 'overflow-y: auto;' : '', this["is-open"] == 'true' ? this.getDialog() : '');
       }
     }], [{
       key: "properties",
       get: function get() {
   ...
   var _templateObject$h, _templateObject2$d, _templateObject3$c, _templateObject4$a, _templateObject5$6, _templateObject6$6, _templateObject7$4;
   /**
     ...
     return _createClass(ODSHeading, [{
       ...
       value: function render() {
         ...
         switch (this["html-tag"]) {
           case 'h1':
             htmlTag = s$1(_templateObject$h || (_templateObject$h = _taggedTemplateLiteral(["h1"])));
             break;
           case 'h2':
             htmlTag = s$1(_templateObject2$d || (_templateObject2$d = _taggedTemplateLiteral(["h2"])));
             break;
           case 'h4':
             htmlTag = s$1(_templateObject3$c || (_templateObject3$c = _taggedTemplateLiteral(["h4"])));
             break;
           case 'h5':
             htmlTag = s$1(_templateObject4$a || (_templateObject4$a = _taggedTemplateLiteral(["h5"])));
             break;
           case 'h6':
             htmlTag = s$1(_templateObject5$6 || (_templateObject5$6 = _taggedTemplateLiteral(["h6"])));
             break;
           case 'h3':
           default:
             htmlTag = s$1(_templateObject6$6 || (_templateObject6$6 = _taggedTemplateLiteral(["h3"])));
             break;
         }
         return n$2(_templateObject7$4 || (_templateObject7$4 = _taggedTemplateLiteral(["\n      <style>\n        * {\n          font-family: \"gilroy\", sans-serif;\n          font-weight: var(--ods-font-weight-600);\n          color: var(", ");\n          color: ", ";\n          margin: var(--ods-sem-space-none);\n          padding: var(--ods-sem-space-none);\n        }\n    \n        .ods-heading--size-xxs {\n          font-size: 16px;\n          line-height: 24px;\n        }\n        \n        .ods-heading--size-xs{\n          font-size: 20px;\n          line-height: 28px;\n        }\n    \n        .ods-heading--size-sm{\n          font-size: 24px;\n          line-height: 32px;\n        }\n    \n        .ods-heading--size-md{\n          font-size: 32px;\n          line-height: 40px;\n        }\n    \n        .ods-heading--size-lg{\n          font-size: 40px;\n          line-height: 48px;\n        }\n       \n      \n      </style>\n      <", " part='odsHeading' class=\"ods-heading--size-", "\">\n      <slot></slot>\n    </", ">\n    "])), alias, this.color, htmlTag, this["text-size"], htmlTag);
       }
     }], [{
       key: "properties",
       get: function get() {
   ...
   var _templateObject$g, _templateObject2$c, _templateObject3$b, _templateObject4$9, _templateObject5$5, _templateObject6$5;
   ...
   var ODSText = /*#__PURE__*/function (_LitElement) {
     ...
     return _createClass(ODSText, [{
       ...
       value: function updated() {
         ...
         if ((this['label-for'] || this['label-for'] !== '') && this['html-tag'] === 'label') thisLabel.setAttribute('for', this['label-for']);else thisLabel.removeAttribute('for');
       }
     }, {
       key: "render",
       value: function render() {
         var htmlTag = null;
         var size = this["text-size"].toLowerCase();
         var weight = this.weight.toLowerCase();
         var alias = odsAliases[this.color];
         switch (this["html-tag"]) {
           case 'p':
             htmlTag = s$1(_templateObject$g || (_templateObject$g = _taggedTemplateLiteral(["p"])));
             break;
           case 'div':
             htmlTag = s$1(_templateObject2$c || (_templateObject2$c = _taggedTemplateLiteral(["div"])));
             break;
           case 'code':
             htmlTag = s$1(_templateObject3$b || (_templateObject3$b = _taggedTemplateLiteral(["code"])));
             break;
           case 'label':
             htmlTag = s$1(_templateObject4$9 || (_templateObject4$9 = _taggedTemplateLiteral(["label"])));
             break;
           case 'span':
           default:
   ...
   var OdsTooltip = /*#__PURE__*/function (_LitElement) {
     ...
     return _createClass(OdsTooltip, [{
       ...
       key: "render",
       value: function render() {
         return x(_templateObject$f || (_templateObject$f = _taggedTemplateLiteral([" \n    <style>\n    :host {\n      visibility:hidden;\n      width: max-content;\n      position: absolute;\n      z-index: 999;\n      top: var(--ods-sem-space-none);\n      left: var(--ods-sem-space-none);\n      background: var(--ods-sem-color-background-primary);\n      color: var(--ods-sem-text-primary);\n      border-radius: var(--ods-sem-radius-sm);\n      max-width: 240px;\n      box-shadow: var(--ods-sem-shadow-sm-x) var(--ods-sem-shadow-sm-y) var(--Shadow-Small-Blur, 4px) var(--ods-sem-shadow-sm-spread) var(--Shadow-Small-Color, var(--ods-sem-shadow-sm-color)); \n    }\n    .tooltip{\n      padding: var(--ods-sem-space-xs) var(--ods-sem-space-sm);\n      border-radius: var(--ods-sem-radius-sm);\n      box-shadow: 0 0 0 0 white, 0 0 0 1px var(--ods-sem-color-border-decorative-primary);\n      overflow-wrap: break-word;\n      hyphens: auto;\n    }\n    #arrow {\n      position: absolute;\n      background: var(--ods-sem-color-border-decorative-primary);\n      width: var(--ods-sem-space-sm);\n      height: var(--ods-sem-space-sm);\n    }\n    #indicator {\n      position: absolute;\n      background: var(--ods-sem-color-background-primary);\n      width: var(--ods-sem-space-sm);\n      height: var(--ods-sem-space-sm);\n    }\n    </style>\n    <div role=\"tooltip\" class='tooltip'>\n      <ods-text tag='span' text-size='sm'>", "</ods-text>\n      <div id='arrow'><div id='indicator'></div>\n    </div>                        \n    "])), this.label);
       }
     }]);
   }(s$2);
   ...
   var _templateObject$e, _templateObject2$b, _templateObject3$a, _templateObject4$8;
   var OdsIconButton = /*#__PURE__*/function (_LitElement) {
     ...
     return _createClass(OdsIconButton, [{
       ...
       value: function getButton() {
         var tabindex = this["is-disabled"] == 'true' ? -1 : 0;
         if (this.url) {
           return x(_templateObject2$b || (_templateObject2$b = _taggedTemplateLiteral(["\n      <a class=' btn-", " ", "' href= \"", "\" target=\"", "\"  tabindex= \"", "\" aria-disabled = \"", "\"  aria-describedby='tooltip_", "' >\n      <i class='icon'> ", " </i>\n      </a>\n      "])), this.variant || 'outline', this["is-disabled"] == 'true' ? "disabled-".concat(this.variant) : '', this.url, this["new-tab"] == 'true' ? '_blank' : '_self', tabindex, this["is-disabled"] == 'true' ? 'true' : 'false', this.tooltipId, this.getIcon());
         } else {
           return x(_templateObject3$a || (_templateObject3$a = _taggedTemplateLiteral(["\n      <button @click=\"", "\" class='btn-", " ", "' tabindex= \"", "\" aria-disabled = \"", "\" aria-describedby='tooltip_", "'>\n     <i class='icon'> ", " </i>\n      </button>\n      "])), this.onClick, this.variant || 'outline', this["is-disabled"] == 'true' ? "disabled-".concat(this.variant) : '', tabindex, this["is-disabled"] == 'true' ? 'true' : 'false', this.tooltipId, this.getIcon());
         }
       }
     }, {
       key: "makeId",
       ...
       key: "render",
       value: function render() {
         var borderRadius = this.shape === 'round' ? 'var(--ods-sem-radius-full)' : 'var( --ods-sem-space-sm)';
         return x(_templateObject4$8 || (_templateObject4$8 = _taggedTemplateLiteral(["\n  \n    <style>\n    :host{\n      display: inline-flex;\n    }\n    \n    a, button {\n        border-radius: ", ";\n        height:var(--ods-sem-icon-button-height);\n        width:var(--ods-sem-icon-button-width);\n        text-decoration: none;\n        border: var(--ods-sem-space-none);\n        cursor: pointer;\n        justify-content: center;\n        box-sizing: border-box;\n        display: inline-flex;\n        align-items: center;\n        padding: 0;\n      }\n\n    .btn-outline {\n        color: var(--ods-sem-color-roles-primary);\n        background-color: var(--ods-sem-color-roles-primary-on-primary) ;\n        box-shadow:0 0 0 1px ;\n    }\n\n    .btn-outline:hover {\n      background: var(--ods-sem-color-utility-states-primary-hover);\n    }\n\n    .btn-outline:active, .btn-outline[active-menu]{\n      background: var(--ods-sem-color-utility-states-primary-pressed);\n    }\n\n    :host(:focus-within) .btn-outline{\n     outline: none;\n     box-shadow: 0 0 0 1px var(--ods-sem-color-utility-states-focus), 0 0 0 0.188rem var(--ods-sem-color-roles-primary-on-primary), 0 0 0 0.35rem var(--ods-sem-color-utility-states-focus);\n    }\n   \n    .btn-ghost {\n    color: var(--ods-sem-color-roles-primary);\n    background: transparent;\n    }\n\n    .btn-ghost:hover {\n    background: var(--ods-sem-color-utility-states-primary-hover);\n    }\n\n    .btn-ghost:active, .btn-ghost[active-menu]{\n    background: var(--ods-sem-color-utility-states-primary-pressed);\n    }\n\n    :host(:focus-within) .btn-ghost{\n      outline: none;\n      box-shadow: 0 0 0 2px var(--ods-sem-color-utility-states-focus);\n    }\n\n\n    .disabled-outline, .disabled-outline:hover, :host(:focus-within) .disabled-outline {\n      color: var(--ods-sem-color-utility-states-disabled-content);\n      opacity: 0.5;\n      background: var(--ods-sem-color-utility-states-disabled-container);\n      box-shadow: 0 0 0  1px !important;\n      cursor: not-allowed;\n      pointer-events: none;\n\n    }\n\n    .disabled-ghost, .disabled-ghost:hover, .disabled-ghost:focus{\n      border-radius: ", ";\n      color: var(--ods-sem-color-utility-states-disabled-content);\n      background: var(--ods-sem-color-utility-states-disabled-container);\n      opacity: 0.5;\n      cursor: not-allowed;\n      pointer-events: none;\n      box-shadow: none !important;    \n    }\n\n    .icon {\n        display: inline-flex;\n        align-items: center;\n        }\n \n    .iconbutton-container:has(.disabled-outline, .disabled-ghost){\n      cursor: not-allowed;\n      }\n\n    </style>\n    <div class=\"iconbutton-container\">", "\n    <ods-tooltip id='tooltip_", "' label=\"", "\" ></ods-tooltip> \n    </div>\n      "])), borderRadius, borderRadius, this.getButton(), this.tooltipId, this.tooltip);
       }
     }], [{
       key: "properties",
       get: function get() {
   ...
   var _templateObject$d, _templateObject2$a, _templateObject3$9, _templateObject4$7, _templateObject5$4, _templateObject6$4;
   ...
   var OdsMenuItem = /*#__PURE__*/function (_LitElement) {
     ...
     return _createClass(OdsMenuItem, [{
       ...
       value: function isSelectable() {
         var _this$_parent;
         return (_this$_parent = this._parent) === null || _this$_parent === void 0 ? void 0 : _this$_parent.selectable;
       }
     }, {
       key: "updated",
       value: function updated() {
         ...
         this._selectable = (_this$_parent2 = this._parent) === null || _this$_parent2 === void 0 ? void 0 : _this$_parent2.selectable;
       }
     }, {
       key: "firstUpdated",
       value: function firstUpdated() {
       ...
       value: function handleClick(e) {
         ...
         if (this.isSelectable()) {
           if (this.isSingleSelect()) {
             ...
             var isSelected = this["is-selected"] == 'true';
             console.log(isSelected, this["is-selected"]);
             this["is-selected"] = !isSelected.toString();
           }
       ...
       value: function handleSelectedArrayOwnPosition() {
         ...
         if (ownIndex === -1 && this["is-selected"] == 'true') this._parent._selectedItems.push(this);
         if (ownIndex > -1 && !this["is-selected"]) this._parent._selectedItems.splice(ownIndex, 1);
         if (ownIndex > -1 && this["is-selected"] == 'true') {
       ...
       value: function getSlots() {
         return x(_templateObject2$a || (_templateObject2$a = _taggedTemplateLiteral(["\n    ", "\n    <div class='start-container'>\n      <slot name='start' @slotchange=\"", "\" /></slot>\n    </div>\n    <div class='text-container'>\n      <div class='maintext-container'>\n      <slot name='label' @slotchange=\"", "\"></slot>\n      </div>\n      <div class='subtext-container'>\n        <slot name='sub-label' @slotchange=\"", "\"></slot>\n      </div>\n      </div>\n      <div class='end-container'>\n        <slot name='end' @slotchange=\"", "\" /></slot>\n      </div>\n    "])), this._selectable ? x(_templateObject3$9 || (_templateObject3$9 = _taggedTemplateLiteral(["\n    <div class='check-container'>\n        ", "\n        ", "\n    </div>"])), this["is-selected"] == 'true' ? x(_templateObject4$7 || (_templateObject4$7 = _taggedTemplateLiteral(["<ods-icon icon-size='sm' icon-name='check'></ods-icon>"]))) : '', !this["is-selected"] == 'true' ? x(_templateObject5$4 || (_templateObject5$4 = _taggedTemplateLiteral(["<div class='no-icon'></div>"]))) : '') : '', this.handleSlotChange, this.handleSlotChange, this.handleSlotChange, this.handleSlotChange);
       }
     }, {
       key: "createRenderRoot",
       value:
   ...
   var _templateObject$c, _templateObject2$9, _templateObject3$8, _templateObject4$6;
   ...
   var OdsMenuDivider = /*#__PURE__*/function (_LitElement) {
     ...
     return _createClass(OdsMenuDivider, [{
       ...
       value: function getDivider() {
         return x(_templateObject$c || (_templateObject$c = _taggedTemplateLiteral(["\n      ", "\n      ", "\n    "])), !this["hide-divider"] == 'true' && this.label || !this.label ? x(_templateObject2$9 || (_templateObject2$9 = _taggedTemplateLiteral(["<div class='divider' part='ods-menu-divider'></div>"]))) : '', this.label ? x(_templateObject3$8 || (_templateObject3$8 = _taggedTemplateLiteral(["<div class=\"label\" part='ods-menu-divider-label'><ods-text text-size=\"sm\" weight='bold' color=\"text-tertiary\">", "</ods-text></div>"])), this.label) : '');
       }
     }, {
       key: "render",
       value: function render() {
   ...
   var _templateObject$b, _templateObject2$8, _defineProperty2;
   ...
   var OdsMenu = /*#__PURE__*/function (_LitElement) {
     ...
     return _createClass(OdsMenu, [{
       ...
       value: function shouldCloseMenu(ev) {
         ...
         var insideOdsComponent = target.nodeName.toLowerCase().includes("ods") && this['no-close-on-select'] == 'true';
         var shouldClose = !insideOdsComponent && this._isOpen;
         if (!shouldClose) this.setMenuPosition();
         return shouldClose;
       }
     }, {
       key: "handleSlotChange",
       ...
       value: function _handleSingleClick(e) {
         ...
         this.getSelectedMenuItems().forEach(function (menuItem) {
           if (menuItem !== currentMenuItem) menuItem["is-selected"] = "false";
         });
       }
     }, {
       ...
       value: function _handleScroll(event) {
         if (this._isOpen) {
           this.closeMenu(); // Close the menu when a scroll event is detected
         }
       }
     }, {
       key: "render",
       value: function render() {
         ...
         return x(_templateObject$b || (_templateObject$b = _taggedTemplateLiteral([" \n    <style>\n    *, :host{\n      font-size: 14px;\n    }\n    :host{\n      position: absolute;\n      /* Shadow/Small */\n      box-shadow: var(--ods-sem-shadow-sm-x) var(--ods-sem-shadow-sm-y) var(--ods-sem-shadow-sm-blur) var(--ods-sem-shadow-sm-spread) var(--ods-sem-shadow-color);\n      border-radius: var(--ods-border-radius-sm);\n      outline: 0;\n      z-index: 998;\n    }\n    .menu-container{\n      display: flex;\n      flex-direction: column;\n      align-items: flex-start;\n      gap: var(--ods-sem-space-none);\n      align-self: stretch;\n      font-family: lato;\n      background: var(--ods-sem-color-background-primary);\n      \n      ", "\n      ", "\n      ", "\n      min-height: min-content;\n      max-height: ", ";\n      overflow-x: clip;\n      text-wrap: wrap;\n      word-wrap: break-word;\n      overflow-y: auto;\n      position: relative;\n      border-radius: var(--ods-sem-radius-sm);\n      outline: 0;\n     \n    }\n      nav{\n      outline: 0;\n      }\n    \n    ::slotted(ods-menu-divider){\n      padding: var(--ods-sem-space-none) var(--ods-sem-space-md) !important;\n      gap: var(--ods-sem-space-none);\n      align-self: stretch;\n      font-size: 14px;\n    }\n\n    ::slotted(ods-menu-divider){\n      padding: var(--ods-sem-space-none) var(--ods-sem-space-md) !important;\n      gap: var(--ods-sem-space-none);\n      align-self: stretch;\n      font-size: 14px;\n    }\n\n    .check-container, .icon-container{\n      width: var(--ods-sem-space-lg);\n      height: var(--ods-sem-space-lg);\n    }\n\n    .hide-menu, .invalid-menu{\n      display: none;\n    }\n\n    .no-items{\n      display: flex;\n      padding: var(--ods-sem-space-sm) var(--ods-sem-space-md) !important;\n      flex-direction: column;\n      align-items: center;\n      justify-content: normal;\n      gap: var(--ods-sem-space-none);\n      flex-shrink: 0;\n      font-size: 14px;\n      line-height: 22px;\n      color: var(--ods-sem-color-text-tertiary);\n      min-height: 24px;\n    }\n      \n    .menu-container::-webkit-scrollbar {\n      width: 10px;\n    }\n    \n    .menu-container::-webkit-scrollbar-track {\n      background-color: var(--ods-sem-color-background-primary);\n      border-radius: var(--ods-sem-radius-full);\n    }\n    \n    .menu-container::-webkit-scrollbar-thumb {\n      background-color: var(--ods-sem-color-border-decorative-primary);\n      border-radius: var(--ods-sem-radius-full);\n      height:30px;\n    }\n      ul{\n      padding: 0; margin:0;}\n    </style>\n    <nav>\n    <ul tabindex=\"0\" class='menu-container hide-menu' part='ods-menu' \n      @menu-item-single-event=", " \n      @menu-item-slot-change-event=", " \n      @menu-item-key-event=", ">\n      <slot @slotchange=\"", "\"></slot>    \n      ", "\n    </ul>\n    </nav>\n    "])), this['match-width'] != 'true' ? "min-width: 184px; max-width: ".concat(this['max-width'], ";") : '', this['match-width'] == 'true' ? "width: ".concat(this._anchoredWidth, "px;") : '', this._isMobile ? "width: ".concat(this._anchoredWidth, "px; max-width: unset;") : '', height, this._handleSingleClick, this._handleItemSlotChanges, this._handleKeyMenuItemEvents, this.handleSlotChange, this._empty ? x(_templateObject2$8 || (_templateObject2$8 = _taggedTemplateLiteral(["<div class='no-items'>", "</div>"])), this['no-items-label']) : null);
       }
     }]);
   }(s$2);
   _defineProperty(OdsMenu, "properties", (_defineProperty2 = {}, _defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty2, 'match-width', {
     ...
     state: true
   }), _defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty2, "_isOpen", {
     state: true
   }), "_anchored", {
     state: true
   }), "_isValid", {
   ...
   /**
    * Check if prop is missing to render empty component
    */
   function isAvailable(arg) {
   ...
   var _templateObject$a, _templateObject2$7, _templateObject3$7, _templateObject4$5, _templateObject5$3, _templateObject6$3, _templateObject7$3, _templateObject8$1, _templateObject9$1, _templateObject10$1;
   var OdsSelectField = /*#__PURE__*/function (_LitElement) {
     function OdsSelectField() {
       ...
       _this["placeholder-text"] = "Select";
       _this["is-disabled"] = 'false';
       _this["is-required"] = 'false';
     ...
     return _createClass(OdsSelectField, [{
       ...
       value: function selectClear() {
         ...
         this.shadowRoot.getElementById("".concat(this["input-name"])).setAttribute("value", '');
         this.shadowRoot.querySelector('ods-menu').selectClear();
       }
     }, {
       key: "getInputField",
       value: function getInputField() {
         var isRequired = this["is-required"] == "true" ? true : false;
         console.log(isRequired, this["is-required"]);
         ...
         return x(_templateObject$a || (_templateObject$a = _taggedTemplateLiteral(["\n      <input\n        readonly\n        tabindex=\"2\"\n        type=\"", "\"\n        class=", "\n        id=\"", "\"\n        name=\"", "\"\n        placeholder=\"", "\"\n        error=\"", "\"\n        aria-describedby=\"", "\"\n        @blur=\"", "\"\n        .value=\"", "\"\n        aria-disabled=\"", "\"\n        ?required=\"", "\"\n        ?optional=\"", "\"\n        aria-invalid=\"", "\"\n        anchor=\"", "\"\n        ", "\n        @ods-active-menu-event=", "\n      />\n      <span class=\"icon-wrapper\">\n        <ods-icon\n            class=\"ods-chevron-container\"\n            icon-size=\"SM\"\n            icon-name=\"chevron-down\"\n            color=\"\"\n          ></ods-icon>\n        </span>\n    "])), this["input-type"], ["ods-form-control", "ods-input-select"].join(" "), this["input-name"], this["input-name"], this["placeholder-text"], this['error-text'], this["input-name"], this.onBlur, this.value, this["is-disabled"], isRequired, isOptional, errorAlert, this["input-name"], n(this.inputRef), this._handleSetActiveMenu);
       }
     }, {
       key: "handleKeyPress",
       ...
       value: function getErrorMessage() {
         if (this['error-text'] && this['error-text'] != "" && !this.isOpened) {
           return x(_templateObject2$7 || (_templateObject2$7 = _taggedTemplateLiteral(["\n        <div class=\"ods-error-container\">\n          <ods-icon\n            icon-size=\"SM\"\n            icon-name=\"error\"\n            color=\"status-error\"\n            aria-describedby=\"tooltip\"\n          ></ods-icon>\n          <ods-text html-tag=\"span\" text-size=\"sm\" weight=\"regular\" color=\"status-error\">\n            ", "\n          </ods-text>\n        </div>\n      "])), this['error-text']);
         }
         return "";
       }
     }, {
       ...
       value: function getLabelText() {
         ...
         if (this["is-required"] == "true") {
           labelText = x(_templateObject5$3 || (_templateObject5$3 = _taggedTemplateLiteral(["", "<ods-text\n          class=\"left-spacing\"\n          html-tag=\"span\"\n          text-size=\"sm\"\n          weight=\"regular\"\n          color=\"text-primary\"\n        >\n          (required)\n        </ods-text>"])), labelText);
         }
         if (this["is-required"] != "true" && this.optional == "true") {
           labelText = x(_templateObject6$3 || (_templateObject6$3 = _taggedTemplateLiteral(["", "<ods-text\n          class=\"left-spacing\"\n          html-tag=\"span\"\n          text-size=\"sm\"\n          weight=\"regular\"\n          color=\"text-primary\"\n          >(optional)</ods-text\n        >"])), labelText);
         }
         return labelText;
       }
     }, {
       ...
       value: function handleItemClick(e) {
         ...
         this.shadowRoot.getElementById("".concat(this["input-name"])).value = value.text;
         this.isOpened = false;
         this.value = value.text;
         this.NgApi.triggerNg(value.value, e);
       ...
       value: function getDropdownMenu() {
         return x(_templateObject9$1 || (_templateObject9$1 = _taggedTemplateLiteral(["<ods-menu\n      @menu-toggle-event=\"", "\"\n      max-width=\"184px\"\n      max-height=\"266px\"\n      match-width=\"true\"\n      anchor=\"buttonWithStart\"\n      selectable=\"true\"\n      .elRef=", "\n      single-select\n    >\n      ", "\n    </ods-menu>"])), this.handleSelectClick, this.inputRef.value, this.getOptions());
       }
 
       /* updateIconPosition() {
         const icon = this.shadowRoot.querySelector(".ods-chevron-container");
         const elmHeight = this.shadowRoot.querySelector(".ods-label-container");
         if (!elmHeight) {
           icon.style.top = "6px";
         } else {
           icon.style.top = `${elmHeight.offsetHeight + 9}px`;
         }
       } */
     }, {
       key: "firstUpdated",
       ...
       key: "connectedCallback",
       value: function connectedCallback() {
         _get(_getPrototypeOf(OdsSelectField.prototype), "connectedCallback", this).call(this);
         this.NgApi = new OdsBridgeApi(this);
       }
     }, {
       key: "disconnectedCallback",
       ...
       value: function updated(changedProperties) {
         ...
         var previousOptions = changedProperties.get("options");
         if (previousOptions != undefined) {
           this._menu = this.getDropdownMenu(this.options);
         }
         var reset = changedProperties.get("reset");
         if (reset != undefined) {
           if (getBoolean(this.reset)) {
             this.selectClear();
           }
         }
       }
     }, {
       key: "updateMenuScroll",
       value: function updateMenuScroll() {
         var menu = this.shadowRoot.querySelector('ods-menu');
         if (menu) {
           var selectedOption = menu.querySelector("[value='".concat(JSON.stringify(this.value), "']"));
           if (selectedOption) {
       ...
       value: function render() {
         this.handleWidth();
         var isReadOnly = this["is-disabled"] == "true" ? "readonly" : "";
         var isError = this['error-text'] != "" ? "error-state" : "";
         ...
         return x(_templateObject10$1 || (_templateObject10$1 = _taggedTemplateLiteral(["\n      <style>\n        :host{\n            ", "\n            position: relative;\n          }\n          * {\n            box-sizng: border-box;\n            margin: var(--ods-sem-space-none);\n            padding: var(--ods-sem-space-none);\n          }\n          .ods-form-label {\n            font-family: lato;\n            font-weight: 400;\n            font-size: 14px;\n            line-height: 24px;\n            margin: var(--ods-sem-space-none);\n            color: var(--ods-sem-color-text-primary);\n          }\n          .ods-form-control {\n            display: block;\n            padding: var(--ods-sem-input-padding);\n            font-size: var(--ods-input-font-size, 16px);\n            font-family: lato, Helvetica, Arial, sans-serif;\n            font-weight: var(--ods-input-font-weight, 400);\n            line-height: var(--ods-input-line-height, 32px);\n            color: var(--ods-sem-color-text-primary);\n            background-color: var(--ods-sem-color-roles-neutral-on-neutral);\n            background-clip: padding-box;\n            box-shadow: 0 0 0 1px var(--ods-sem-color-border-interactive-component);\n            border-width: 0;\n            -webkit-appearance: none;\n            -moz-appearance: none;\n            appearance: none;\n            border-radius: var(--ods-sem-radius-sm);\n            cursor:pointer;\n          }\n          @media (prefers-reduced-motion: reduce) {\n            .ods-form-control {\n              transition: none;\n            }\n          }\n          .ods-form-control::-moz-placeholder {\n            color: var(--ods-sem-color-text-tertiary);\n            opacity: 1;\n          }\n          .ods-form-control::placeholder {\n            color: var(--ods-sem-color-text-tertiary);\n            opacity: 1;\n          }\n          .ods-select-field-container {\n            width: ", ";\n          }\n          .ods-field-container {\n            width: ", ";\n            display: flex;\n            /* position: relative; */\n            flex-direction: column-reverse;\n            gap: var(--ods-sem-space-xxs,2px);\n            box-sizing: border-box;\n          }\n          .ods-label-container {\n            display: flex;\n            align-items: flex-start;\n            gap: 4px;\n          }\n          .ods-label-container ods-icon-button {\n            display: flex;\n            align-items: center;\n            justify-content: center;\n            --ods-icon-button-height: 24px;\n            --ods-icon-button-width: 24px;\n          }\n          .ods-button {\n            display: flex;\n            align-items: center;\n            justify-content: center;\n            --ods-icon-button-height: 24px;\n            --ods-icon-button-width: 24px;\n          }\n          ods-icon-button ods-icon::part(odsIcon) {\n            width: var(--ods-sem-space-md);\n            height: var(--ods-sem-space-md);\n          }\n          .ods-error-container {\n            width: ", ";\n            display: flex;\n            justify-content: flex-start;\n            gap: var(--ods-sem-space-sm);\n          }\n          .ods-error-container ods-icon {\n            display: flex;\n            align-items: center;\n            justify-content: center;\n            height: var(--ods-sem-space-md);\n            width: var(--ods-sem-space-md);\n            padding: var(--ods-sem-space-xs) var(--ods-sem-space-none);\n          }\n\n          .ods-field-container {\n            input {\n              &:hover {\n                border-width: 0;\n                box-shadow: 0 0 0 1px var(--ods-sem-color-roles-primary);\n                ~ .ods-label-container ods-text::part(odsText) {\n                  color: var(--ods-sem-color-utility-states-primary-on-color-hover);\n                }\n                ~ .ods-label-container label {\n                  cursor: pointer;\n                }\n              }\n              &:focus, &[active-menu] {\n                color: var(--ods-sem-color-text-primary);\n                background-color: var(--ods-sem-color-roles-primary-on-primary);\n                box-shadow: 0 0 0 2px var(--ods-sem-color-utility-states-primary-on-color-focus);\n                border-width: 0;\n                outline: 0;\n                ~ .ods-label-container ods-text::part(odsText) {\n                  color: var(--ods-sem-color-utility-states-primary-on-color-focus);\n                }\n              }\n              &:active {\n                box-shadow: 0 0 0 1px var(--ods-sem-color-utility-states-primary-on-color-pressed);\n                ~ .ods-label-container ods-text::part(odsText) {\n                  color: var(--ods-sem-color-utility-states-primary-on-color-pressed);\n                }\n              }\n            }\n            &.readonly {\n              opacity: 0.5;\n              cursor: not-allowed;\n              input {\n                pointer-events: none;\n                color: var(--ods-sem-color-utility-states-disabled-content);\n                background-color: var(--ods-sem-color-utility-states-disabled-container);\n                background-clip: padding-box;\n                box-shadow: 0 0 0 1px var(--ods-sem-color-utility-states-disabled-content);\n                -webkit-appearance: none;\n                -moz-appearance: none;\n                appearance: none;\n              }\n              .ods-label-container ods-text::part(odsText) {\n                pointer-events: none;\n              }\n              .ods-button {\n                pointer-events: none;\n              }\n            }\n            &.error-state {\n              input {\n                box-shadow: 0 0 0 1px var(--ods-sem-color-utility-states-error-on-color-default);\n                border-width: 0;\n                ~ .ods-label-container ods-text::part(odsText) {\n                  color: var(--ods-sem-color-status-roles-error);\n                }\n                &:hover {\n                  box-shadow: 0 0 0 1px var(--ods-sem-color-utility-states-error-on-color-hover);\n                  ~ .ods-label-container ods-text::part(odsText) {\n                    color: var(--ods-sem-color-utility-states-error-on-color-hover);\n                  }\n                }\n                &:focus {\n                  border-color: var(--ods-sem-color-utility-states-error-on-color-focus);\n                  box-shadow: 0 0 0 2px var(--ods-sem-color-utility-states-error-on-color-default);\n                  ~ .ods-label-container ods-text::part(odsText) {\n                    color: var(--ods-sem-color-utility-states-error-on-color-focus);\n                  }\n                }\n                &:active {\n                  box-shadow: 0 0 0 1px var(--ods-sem-color-utility-states-error-on-color-pressed);\n                  ~ .ods-label-container ods-text::part(odsText) {\n                    color: var(--ods-sem-color-utility-states-error-on-color-pressed);\n                  }\n                }\n              }\n            }\n          }\n          ods-text::part(odsText) {\n            line-height: 24px;\n            word-break: break-word;\n          }\n          ods-text.left-spacing {\n            margin-left: 4px;\n          }\n          ods-text {\n            display: inline-block;\n          }\n            button {\n            border-radius: 9999px;\n            height: var(--ods-icon-button-height, 44px);\n            width: var(--ods-icon-button-width, 44px);\n            text-decoration: none;\n            border: var(--ods-sem-space-none);\n            cursor: pointer;\n            justify-content: center;\n            box-sizing: border-box;\n            display: inline-flex;\n            align-items: center;\n            padding: 0;\n          }\n          .btn-ghost {\n            color: var(--ods-sem-color-roles-primary);\n            background: transparent;\n          }\n          .btn-ghost:hover {\n            background: var(--ods-sem-color-utility-states-primary-hover);\n          }\n          .btn-ghost:focus {\n            outline: none;\n            box-shadow: 0 0 0 2px var(--ods-sem-color-utility-states-focus);\n          }\n          .btn-ghost:active {\n            background: var(--ods-sem-color-utility-states-primary-pressed);\n            box-shadow: none;\n          }\n          .ods-chevron-container {\n            position: absolute;\n            right: 16px;\n            top: 8px;\n            transform: ", ";\n            transition: transform 0.2s ease-in-out;\n            display: flex;\n            align-items: center;\n            justify-content: center;\n            height: var(--ods-sem-space-md);\n            width: var(--ods-sem-space-md);\n            /* padding: var(--ods-sem-space-sm) var(--ods-sem-space-none); */\n            pointer-events: none;\n            padding-top: 12px;\n            padding-bottom: 12px;\n          }\n          .select-wrapper {\n            position: relative;\n            input {\n              width: calc(100% - 32px);\n            }\n          }  \n            .icon-wrapper {\n              position: relative;\n            }\n            .ods-input-select { \n              display: block; \n              width: 100%; \n              padding-right:45px; \n              overflow: hidden; \n              white-space: nowrap; \n              text-overflow: ellipsis !important; \n             box-sizing: border-box; \n            }\n            \n            \n      </style>\n      <div class=", ">\n        ", "", " ", "\n        \n      </div>\n      ", "\n    "])), this["full-width"] === "false" ? "display: inline-flex;" : "", this.width, this.width, this.width, iconPosition, ["ods-field-container", isReadOnly, isError].join(" "), this.getErrorMessage(), this.getInputField(), this.getLabelField(), this._menu);
       }
     }], [{
       key: "properties",
       get: function get() {
   ...
   var _templateObject$9, _templateObject2$6, _templateObject3$6, _templateObject4$4, _templateObject5$2, _templateObject6$2, _templateObject7$2;
   var ODSTextArea = /*#__PURE__*/function (_LitElement) {
     ...
     return _createClass(ODSTextArea, [{
       key: "onBlur",
       value: function onBlur(e) {
         this.NgApi.triggerNg(e.target.value, e);
       }
     }, {
       key: "onInput",
       ...
       value: function firstUpdated() {
         ...
         //        var width = `${item.contentRect.width + item.contentRect.x *2}px`;
         //         this.width = width;
       ...
       value: function getInputField() {
         var isRequired = this["is-required"] == "true" ? true : false;
         var isOptional = this["is-optional"] == "true" ? true : false;
         if (isRequired) {
           isOptional = false;
         }
         var errorAlert = false;
         ...
         return x(_templateObject$9 || (_templateObject$9 = _taggedTemplateLiteral(["\n    <textarea\n    @input=\"", "\"\n    @blur=\"", "\"\n    tabindex=\"2\"\n    class=", "\n    id=\"", "\"\n    name=\"", "\"\n    resize=\"", "\"\n    placeholder=\"", "\"\n    error=\"", "\"\n    aria-describedby=\"", "\"\n    aria-disabled=\"", "\"\n    .value=\"", "\"\n    ?required=\"", "\"\n    ?optional=\"", "\"\n    aria-invalid=\"", "\"\n    @resize=\"", "\"\n\n  ></textarea>\n    "])), this.onInput, this.onBlur, ["ods-form-control"].join(" "), this["input-name"], this["input-name"], this.resize, this["placeholder-text"], this["error-text"], this["input-name"], this["is-disabled"], this.value, isRequired, isOptional, errorAlert, this.handletextsize);
       }
     }, {
       key: "getErrorMessage",
       value: function getErrorMessage() {
         if (this["error-text"] && this["error-text"] != "") {
       ...
       value: function getLabelText() {
         ...
         if (this["is-required"] != "true" && this["is-optional"] == "true") {
   ...
   var _templateObject$8, _templateObject2$5, _templateObject3$5, _templateObject4$3, _templateObject5$1, _templateObject6$1, _templateObject7$1;
   ...
   var ODSTextField = /*#__PURE__*/function (_LitElement) {
     ...
     return _createClass(ODSTextField, [{
       key: "customEventHandler",
       value: function customEventHandler(event, eventName) {
         var obj = {};
         obj[this["input-name"]] = event.target.value;
         var myEvent = new CustomEvent(eventName, {
           detail: _objectSpread2({}, obj),
           bubbles: true,
           composed: true
         });
       ...
       value: function onBlur(e) {
         this.NgApi.triggerNg(e.target.value, e);
         this.customEventHandler(e, 'ods-text-field-blur');
       }
     }, {
       key: "onInput",
       value: function onInput(e) {
         this.NgApi.triggerNg(e.target.value, e);
         this.customEventHandler(e, 'ods-text-field-change');
       }
     }, {
       key: "getInputField",
       value: function getInputField() {
         ...
         return x(_templateObject$8 || (_templateObject$8 = _taggedTemplateLiteral(["\n      <input\n        tabindex=\"2\"\n        type=\"", "\"\n        class=", "\n        @input=\"", "\"\n        @blur=\"", "\"\n        id=\"", "\"\n        name=\"", "\"\n        placeholder=\"", "\"\n        error=\"", "\"\n        aria-describedby=\"", "\"\n        aria-disabled=\"", "\"\n        .value=\"", "\"\n        ?required=\"", "\"\n        ?optional=\"", "\"\n        aria-invalid=\"", "\"\n      />\n    "])), this.type, ["ods-form-control"].join(" "), this.onInput, this.onBlur, this["input-name"], this["input-name"], this["placeholder-text"], this["error-text"], this["input-name"], this["is-disabled"], this.value, isRequired, isOptional, errorAlert);
       }
     }, {
       key: "getErrorMessage",
       value: function getErrorMessage() {
     ...
     return _createClass(Tab, [{
       ...
       value: function handleTabSelected(e) {
         if (!this["more-tab"]) {
           ...
           if (this.url) {
             window.open(this.url, this["new-tab"] == 'true' ? '_blank' : '_self');
           }
           if (!this.selected) {
             this.selected = true;
             this.requestUpdate();
   ...
   var TabGroup = /*#__PURE__*/function (_LitElement) {
     ...
     return _createClass(TabGroup, [{
       ...
       value: function updated(changedProperties) {
         ...
         if (oldFullWidthValue !== this["full-width"] == 'true' && typeof oldFullWidthValue !== 'undefined') {
           this.reprocessTabs();
         }
       }
     }, {
       ...
       value: function handleTabClick(event) {
         ...
         this.updateActiveTab();
         this.NgApi.triggerNg(this.activeTabIndex, event);
       }
     }, {
       key: "disconnectedCallback",
       value: function disconnectedCallback() {
       ...
       key: "connectedCallback",
       value: function connectedCallback() {
         _get(_getPrototypeOf(TabGroup.prototype), "connectedCallback", this).call(this);
         this.NgApi = new OdsBridgeApi(this);
       }
     }, {
       key: "handleItemClick",
       ...
       value: function getMoreTabItem() {
         return x(_templateObject$5 || (_templateObject$5 = _taggedTemplateLiteral(["<ods-tab more-tab ", " hide\n   @ods-active-menu-event=", ">\n      ", "\n        <ods-icon icon-name='chevron-up' color='role-on-primary' icon-size=\"sm\" slot='more-icon'></ods-icon>    \n    </ods-tab>"])), n(this.moreButtonRef), this._handleSetActiveMenu, this['more-label']);
       }
     }, {
       ...
       value: function getDropdownMenu(tabs) {
         ...
         if (tabs && tabs.length > 0) {
           this._menu = x(_templateObject3$3 || (_templateObject3$3 = _taggedTemplateLiteral(["<ods-menu\n      @menu-toggle-event=\"", "\"\n      max-width=\"184px\"\n      max-height=\"266px\"\n      anchor=\"buttonWithStart\"\n      .elRef=\"", "\"\n    >\n       ", "\n    </ods-menu>"])), this.handleMenuToggle, this.moreButtonRef.value, this.getTabOptions(tabs));
         }
       }
     }, {
       key: "render",
       value: function render() {
         ...
         return x(_templateObject4$2 || (_templateObject4$2 = _taggedTemplateLiteral(["\n    <style>\n    :host {\n      display: inline-flex;\n      width: 100%;\n      justify-content: stretch;\n      \n    }\n\n    .ods-tab-group-container {\n      display:inline-flex;\n      flex-direction: column;\n      max-width: 100%;\n      ", "\n        \n    }\n\n    nav{\n        padding: ", "\n      background-color: var(--ods-sem-color-brand-infinite-blue);\n      \n        \n    }\n    \n    .ods-tab-nav-list {\n      display: inline-flex;\n      position:relative;\n      list-style: none;\n      padding: var(--ods-sem-radius-none);\n      margin: var(--ods-sem-radius-none);\n      width: 100%;\n       ", "\n    }\n\n    @media (max-width: 320px){\n      .ods-tab-nav-list li:first-child, .ods-tab-nav-list li:last-child\n    }\n      padding-left: var(--ods-sem-radius-none);\n      padding-right: var(--ods-sem-radius-none);\n\n    }\n\n    </style>\n    <div @tab-loaded=", "  class='ods-tab-group-container'>\n      <nav> \n        <ul class='ods-tab-nav-list' part=\"odsTabGroup\">\n          <slot name=\"tab\">\n          </slot>\n          ", "\n          ", "\n        </ul>\n      </nav>\n      <div class='ods-tab-panel-group'>\n        <slot name=\"tabpanel\">\n        </slot>\n      </div>\n    </div>\n    \n    "])), this["full-width"] == 'true' || this.isMobile ? 'width: 100%;' : '', this["remove-side-padding"] == 'true' || this.isMobile ? ' 0px;' : '0 24px;', this["full-width"] == 'true' ? 'flex:1;' : '', this._handleTabLoaded, this.getMoreTabItem(), this._menu);
       }
     }], [{
       key: "properties",
       get: function get() {
   ...
   /**
    * Service Now ODS Tag Component
    * @input variant, inverse, label
    * @output <ods-tag> in dom
    */
 
   var OdsTag = /*#__PURE__*/function (_LitElement) {
     function OdsTag() {
       var _this;
       _classCallCheck(this, OdsTag);
       _this = _callSuper(this, OdsTag);
       _this.variant = "neutral";
       _this.inverse = 'false';
       return _this;
     }
     _inherits(OdsTag, _LitElement);
     return _createClass(OdsTag, [{
       key: "getText",
       value: function getText() {
         var colorMap = {
           neutral: {
             "true": "text-inverse",
             "false": "role-on-neutral-container"
           },
           positive: {
             "true": "text-inverse",
             "false": "role-on-primary-container"
           },
           negative: {
             "true": "text-inverse",
             "false": "status-error-on-container"
           },
           warning: {
             "true": "text-inverse",
             "false": "status-on-warning-container"
           },
           informative: {
             "true": "text-inverse",
             "false": "role-on-secondary-container"
           },
           accent: {
             "true": "text-inverse",
             "false": "role-on-accent-container"
           }
         };
         var color = (colorMap[this.variant] || {}).hasOwnProperty(this.inverse) ? colorMap[this.variant][this.inverse] : "text-inverse";
         return x(_templateObject$4 || (_templateObject$4 = _taggedTemplateLiteral(["\n        <ods-text color=\"", "\" text-size=\"sm\">", "</ods-text>\n        "])), color, this.label);
       }
     }, {
       key: "handleSlotChange",
       value: function handleSlotChange(event) {
         var slot = event.target;
         this.setIconColor(slot);
       }
     }, {
       key: "getIconColor",
       value: function getIconColor() {
         ...
         return (colorMap[this.variant] || {}).hasOwnProperty(this.inverse) ? colorMap[this.variant][this.inverse] : "icon-inverse";
       }
     }, {
       key: "getTag",
       value: function getTag() {
         return x(_templateObject2$2 || (_templateObject2$2 = _taggedTemplateLiteral(["\n      <div class='ods-tag ods-tag-", " ", "' >\n      <slot name=\"start\" @slotchange=", "></slot>  \n      ", "\n      <slot name=\"end\" @slotchange=", "></slot>\n      </div>\n      "])), this.variant, this.inverse == 'true' ? "ods-tag-inverse-".concat(this.variant) : '', this.handleSlotChange, this.getText(), this.handleSlotChange);
       }
     }, {
       key: "setIconColor",
       value: function setIconColor(slot) {
         var _this2 = this;
         var assignedNodes = slot.assignedNodes({
           flatten: true
         });
         assignedNodes.forEach(function (node) {
           if (node.nodeName === 'ODS-ICON') {
             var iconElement = node.shadowRoot ? node.shadowRoot.querySelector('.ods-icon--md') : node;
             if (iconElement) {
               iconElement.classList.remove('ods-icon--md');
               iconElement.style.height = '14px';
               iconElement.style.width = '14px';
             }
             var color = _this2.getIconColor();
       ...
       key: "validateSlot",
       value: function validateSlot() {
         var _this3 = this;
         var query = this.shadowRoot.querySelectorAll('slot[name="start"], slot[name="end"]');
         query.forEach(function (slot) {
           _this3.setIconColor(slot);
         });
       }
     }, {
       key: "render",
       value: function render() {
         this.validateSlot();
         return x(_templateObject3$2 || (_templateObject3$2 = _taggedTemplateLiteral(["\n  \n    <style>\n    :host{\n      display: inline-flex;\n      margin: var(--ods-sem-space-xs);\n    }\n    \n    .ods-tag {\n      border-radius: var(--ods-sem-radius-full);\n      text-decoration: none;\n      cursor: pointer;\n      justify-content: center;\n      box-sizing: border-box;\n      display: inline-flex;\n      align-items: center;\n      padding: var(--Padding-Vertical, 1px) var(--Padding-Horizontal, 12px);\n      gap: var(--Gap, 6px);\n      pointer-events: none;\n    }\n\n    .ods-tag-neutral{\n     background: var(--ods-sem-color-roles-neutral-container);\n    }\n    \n    .ods-tag-positive{\n     background: var(--ods-sem-color-status-roles-success-container);\n    }\n\n    .ods-tag-warning{\n    background: var(--ods-sem-color-status-roles-warning-container);\n    }\n\n    .ods-tag-negative{\n    background: var(--ods-sem-color-status-roles-error-container);\n    }\n\n    .ods-tag-informative{\n     background: var(--ods-sem-color-roles-secondary-container);\n    }\n\n    .ods-tag-accent{\n     background: var(--ods-sem-color-roles-accent-container);\n    }\n    \n\n    .ods-tag-inverse-neutral{\n     background: var(--ods-sem-color-roles-neutral);\n\n    }\n\n    .ods-tag-inverse-positive{\n    background: var(--ods-sem-color-status-roles-success);\n    }\n    \n     .ods-tag-inverse-warning{\n     background: var(--ods-sem-color-status-roles-warning);\n    }\n    \n     .ods-tag-inverse-negative{\n     background: var(--ods-sem-color-status-roles-error);\n     }\n\n     .ods-tag-inverse-informative{\n     background: var(--ods-sem-color-status-roles-info);\n     }\n\n     .ods-tag-inverse-accent{\n      background: var(--ods-sem-color-roles-accent);\n     }\n    \n    </style>\n    <div class=\"tag-container\">", "\n    </div>\n      "])), this.getTag());
       }
     }], [{
       key: "properties",
       get: function get() {
   ...
   customElements.define('ods-tag', OdsTag);
 
   var _templateObject$3;
 
   /**
    * Service Now OdsCheckbox Component
    * @input label, type
    * @output <ods-checkbox> in dom
    */
   var OdsCheckbox = /*#__PURE__*/function (_LitElement) {
     function OdsCheckbox() {
       var _this;
       _classCallCheck(this, OdsCheckbox);
       _this = _callSuper(this, OdsCheckbox);
       _this.isWrapping = false;
       _this.NgApi = null;
       return _this;
     }
     _inherits(OdsCheckbox, _LitElement);
     return _createClass(OdsCheckbox, [{
       key: "handleSelect",
       value: function handleSelect() {
         var el = this.shadowRoot.querySelector(".form-check-input");
         var value = getBoolean(this["is-selected"]);
         el.checked = value;
       }
     }, {
       ...
       value: function handleIndeterminate() {
         var el = this.shadowRoot.querySelector(".form-check-input");
         var isIndeterminate = getBoolean(this.indeterminate);
         if (isIndeterminate) {
       ...
       key: "checkLabelWrapping",
       value: function checkLabelWrapping() {
         var _this2 = this;
         var childElement = this.shadowRoot.querySelector("ods-text");
         childElement.updateComplete.then(function () {
           var spanElement = childElement.shadowRoot.querySelector("span");
           var offsetHeight = spanElement.offsetHeight;
           var lineHeight = parseFloat(getComputedStyle(spanElement).lineHeight);
           if (offsetHeight > lineHeight) {
             _this2.isWrapping = true;
           } else {
             _this2.isWrapping = false;
           }
         });
       }
     }, {
       ...
       value: function handleInputChange(e) {
         var el = this.shadowRoot.querySelector(".form-check-input");
         this.customEventHandler(el.checked, "ods-checkbox-change");
         this.NgApi.triggerNg(el.checked, e);
       }
     }, {
       key: "handleBlurEvent",
       value: function handleBlurEvent(e) {
         var el = this.shadowRoot.querySelector(".form-check-input");
         this.customEventHandler(el.checked, "ods-checkbox-blur");
         this.NgApi.triggerNg(el.checked, e);
       }
     }, {
       key: "customEventHandler",
       value: function customEventHandler(isChecked, event) {
         var obj = {};
         if (isChecked) {
           obj[this["input-name"]] = this.value;
           obj["isChecked"] = true;
         } else {
           obj[this["input-name"]] = null;
           obj["isChecked"] = true;
         }
       ...
       value: function handleContainerClick(e) {
         if (e.target.tagName.toLowerCase() == "input" || e.target.tagName.toLowerCase() == "ods-text" || e.target.tagName.toLowerCase() == "label") {
           return "";
         }
         var isDisabled = getBoolean(this["is-disabled"]);
         if (isDisabled) {
           return "";
         }
         var el = this.shadowRoot.querySelector(".form-check-input");
       ...
       key: "firstUpdated",
       value: function firstUpdated() {
         _get(_getPrototypeOf(OdsCheckbox.prototype), "firstUpdated", this).call(this);
         this.checkLabelWrapping();
         this.handleIndeterminate();
       }
     }, {
       key: "updated",
       value: function updated(changedProperties) {
         _get(_getPrototypeOf(OdsCheckbox.prototype), "updated", this).call(this);
         var label = changedProperties.get("label");
         var hideLabel = changedProperties.get("hide-label");
         if (label != undefined || hideLabel != undefined) {
           this.checkLabelWrapping();
         }
         var selected = changedProperties.get("selected");
         if (selected != undefined) {
           this.handleSelect();
         }
         var indteriminate = changedProperties.get("indeterminate");
         if (indteriminate != undefined) {
           this.handleIndeterminate();
         }
       }
     }, {
       key: "connectedCallback",
       value: function connectedCallback() {
         _get(_getPrototypeOf(OdsCheckbox.prototype), "connectedCallback", this).call(this);
         this.NgApi = new OdsBridgeApi(this);
       }
     }, {
       key: "render",
       value: function render() {
         ...
         if (!(isAvailable(this["input-name"]) && isAvailable(this.value))) {
           return null;
         }
         var randomId = getRandomStr();
         var isDisabled = getBoolean(this["is-disabled"]);
         var isReadOnly = isDisabled ? "readonly" : "";
         var isInDeterminate = getBoolean(this.indeterminate) ? "indeterminate" : "";
         var isChecked = getBoolean(this["is-selected"]);
         var isInvalid = getBoolean(this["is-invalid"]);
         var isLabelHide = getBoolean(this["hide-label"]) ? "hide-label" : "";
         var iconType = getBoolean(this.indeterminate) ? "minus" : "check";
         var svgImage = "x_snc_ods." + iconType + ".svg";
         return x(_templateObject$3 || (_templateObject$3 = _taggedTemplateLiteral(["\n      <style>\n        * {\n          margin: var(--ods-sem-space-none);\n          padding: var(--ods-sem-space-none);\n          box-sizing:border-box;\n        }\n        .ods-checkbox-container{\n            display:inline-flex;\n            cursor:pointer;\n            gap:12px;\n            padding:10px ", ";\n            outline-offset:2px;\n            align-items:", ";\n            .form-check-label{\n              margin:0;\n              padding:0;\n              word-break: break-word;\n              cursor:pointer;\n              width:100%;\n              display:inline-block;\n              ods-text{\n                display:inline-block;\n                height:auto;\n                line-height:var(--ods-sem-space-lg);\n                height:var(--ods-sem-space-lg);\n              }\n            }\n            .hide-label{\n              display:none;\n            }\n            .form-check-input {\n              border-radius: var(--ods-sem-radius-sm);\n              min-width: var(--ods-sem-space-lg);\n              height: var(--ods-sem-space-lg);\n              vertical-align: top;\n              cursor:pointer;\n              background-color: var(--ods-sem-color-roles-primary-on-primary);\n              background-repeat: no-repeat;\n              background-position: center;\n              background-size: auto;\n              border:1px solid var(--ods-sem-color-utility-states-primary-on-color-default);\n              -webkit-appearance: none;\n              -moz-appearance: none;\n              appearance: none;\n              -webkit-print-color-adjust: exact;\n              color-adjust: exact;\n            }\n              .form-check-input:focus-visible {\n                outline: none;\n              }\n              &:focus .form-check-input{\n                background-color: var(--ods-sem-color-roles-primary-on-primary);\n                border:1px solid var(--ods-sem-color-utility-states-primary-on-color-focus);\n              }\n              &:hover .form-check-input {\n                background-color: var(--ods-sem-color-utility-states-primary-hover);\n                border: 1px solid var(--ods-sem-color-utility-states-primary-on-color-hover);\n              }\n              &:active .form-check-input{\n                background-color: var(--ods-sem-color-utility-states-primary-pressed);\n                border: 1px solid  var(--ods-sem-color-utility-states-primary-on-color-pressed);\n              }\n            \n            &:focus-within, &:active:not(.readonly) {\n              border-radius: var(--ods-sem-radius-sm);\n              border:none;\n              outline:2px solid var(--ods-sem-color-utility-states-focus);\n              background-color: var(--ods-sem-color-roles-primary-on-primary);\n            }\n        }\n        .ods-checkbox-container.readonly{\n          cursor: not-allowed;\n           .form-check-input{\n            pointer-events: none;\n            background-color:  var(--ods-sem-color-utility-states-disabled-container) !important;\n            opacity: 0.5;\n            border:1px solid var( --ods-sem-color-utility-states-disabled-content)!important;\n        }\n        .form-check-label{\n          pointer-events: none;\n          opacity: 0.5;\n        }\n      }\n      .ods-checkbox-container {\n          .form-check-input:checked,.form-check-input:indeterminate{\n            position:relative;\n            background-color:var(--ods-sem-color-roles-primary);\n          }\n          \n          &:focus .form-check-input:checked,&:focus .form-check-input:indeterminate{\n            background-color: var(--ods-sem-color-utility-states-primary-on-color-focus);\n          }\n          &:hover .form-check-input:checked,&:hover .form-check-input:indeterminate{\n            background-color:var(--ods-sem-color-utility-states-primary-on-color-hover);\n          }\n          &:active .form-check-input:checked,&:active .form-check-input:indeterminate{\n            background-color: var(--ods-sem-color-utility-states-primary-on-color-pressed);\n          }\n        }\n        .form-check-input:checked[type=\"checkbox\"]::before,.form-check-input:indeterminate::before {\n          mask:url(", ");\n          content: '';\n          width: 16px;\n          height: 16px;\n          background-color: ", ";\n          position: absolute;\n          mask-size: 100%;\n          top: 50%;\n          left: 50%;\n          transform: translate(-50%, -50%);\n        }\n      .ods-checkbox-container.readonly{\n          cursor: not-allowed;\n          .form-check-input:checked[type=\"checkbox\"] {\n            pointer-events: none;\n            background-color:  var(--ods-sem-color-utility-states-disabled-content);\n            opacity: 0.5;\n            border:1px solid var( --ods-sem-color-utility-states-disabled-content);\n        }\n      }\n      .ods-checkbox-container{\n          .form-check-input.indeterminate:indeterminate[type=\"checkbox\"] {\n            //background-image: url('data:image/svg+xml;base64,')\n        }\n      }\n      .ods-checkbox-container{\n          .error{\n            border:1px solid var(--ods-sem-color-status-roles-error);\n          }\n          &:focus .error{\n            border:1px solid  var(--ods-sem-color-utility-states-error-on-color-focus);\n          }\n          &:hover .error{\n            background-color: var(--ods-sem-color-utility-states-error-hover);\n            border:1px solid  var(--ods-sem-color-utility-states-error-on-color-hover);\n          }\n          &:active .error{\n            background-color: var(--ods-sem-color-utility-states-error-pressed);\n            border: 1px solid var(--ods-sem-color-utility-states-error-on-color-pressed);\n          }   \n      }\n      .ods-checkbox-container {\n        .error:checked ,.error:indeterminate{\n          background-color:  var(--ods-sem-color-status-roles-error);\n          \n        }\n        &:focus .error:checked , &:focus .error:indeterminate{\n          background-color:var(--ods-sem-color-utility-states-error-on-color-focus);\n          border:1px solid var(--ods-sem-color-utility-states-error-on-color-focus);\n        }\n        &:hover .error:checked , &:hover .error:indeterminate{\n          background-color:var(--ods-sem-color-utility-states-error-on-color-hover);\n          border:1px solid var(--ods-sem-color-utility-states-error-on-color-hover);\n        }\n        &:active .error:checked , &:active .error:indeterminate{\n          background-color:var(--ods-sem-color-utility-states-error-on-color-pressed);\n          border:1px solid var(--ods-sem-color-utility-states-error-on-color-pressed);\n        }\n      }\n      .ods-checkbox-wrapper{\n        display:flex;\n        position:relative;\n        justify-content:center;\n        align-items:center;\n        ods-icon{\n          position:absolute;\n        }\n      }\n      </style>\n      <div class=\"ods-checkbox-container ", " \" @click=\"", "\">\n          <input tabindex=\"", "\"\n            class=\"form-check-input ", " ", "\"\n            type=\"checkbox\"\n            id=\"ods_checkbox_", "\" \n            aria-disabled=\"", "\"\n            aria-describedby=\"checkboxdescription\"\n            ?checked=\"", "\"\n            ?is-invalid=\"", "\"\n            value=\"", "\"\n            @input=\"", "\"\n            @blur=\"", "\"\n          />\n          <label class=\"form-check-label ", "\" for=\"ods_checkbox_", "\">\n          <ods-text class=\"custom-tag\" html-tag=\"span\" text-size=\"md\" weight=\"regular\" color=\"text-primary\">\n          ", "\n          </ods-text>\n          </label>\n          </div>\n        </div>\n      </div>\n    "])), getBoolean(this["hide-label"]) ? "10px" : "0px", this.isWrapping ? "start" : "center", svgImage, isDisabled ? 'var(--ods-sem-color-utility-states-disabled-content)' : 'var(--ods-sem-color-roles-primary-on-primary)', isReadOnly, this.handleContainerClick, isDisabled ? -1 : 0, isInDeterminate, isInvalid ? "error" : "", randomId, this["is-disabled"], isChecked, isInvalid, this.value, this.handleInputChange, this.handleBlurEvent, isLabelHide, randomId, this.label);
       }
     }], [{
       key: "properties",
       get: function get() {
   ...
   customElements.define("ods-checkbox", OdsCheckbox);
   ...
   var ODSLink = /*#__PURE__*/function (_LitElement) {
     ...
     return _createClass(ODSLink, [{
       ...
       value: function getAnchorTag() {
         var linkSize = "btn-link-sm";
         var iconSize = "MD";
         var iconPosition = !this["icon-position"] ? 'end' : this["icon-position"];
         var iconLeft = iconPosition === 'start' ? true : '';
         var iconRight = iconPosition === 'end' ? true : '';
         var icon = !this.icon ? 'placeholder' : this.icon;
         if (this["new-tab"] == "true") {
           iconRight = true;
           iconLeft = false;
           icon = 'new-tab';
         ...
         if (this["text-size"] == "LG") {
           linkSize = "btn-link-lg";
           iconSize = "LG";
         } else if (this["text-size"] == "MD") {
           linkSize = "btn-link-md";
           iconSize = "MD";
         } else if (this["text-size"] == "SM") {
           iconSize = "SM";
           linkSize = "btn-link-sm";
         }
 
         // ${[iconSize]}
         return x(_templateObject$2 || (_templateObject$2 = _taggedTemplateLiteral(["\n        <div class=\"ods-link-wrapper\">\n            <a\n            part=\"sn-wc-link\"\n            href=\"", "\"\n            class=", "\n            target=\"", "\"\n            >\n                ", "\n                <ods-text text-size=", " weight=\"bold\"><slot></slot></ods-text>\n                ", "\n            </a> \n        </div>\n      "])), this.url, [linkSize].join(" "), this["new-tab"] == 'true' ? '_blank' : '_self', iconLeft ? x(_templateObject2$1 || (_templateObject2$1 = _taggedTemplateLiteral(["<ods-icon icon-size=\"SM\" icon-name=\"", "\" color=\"\"></ods-icon>"])), icon || 'placeholder') : '', [iconSize], iconRight ? x(_templateObject3$1 || (_templateObject3$1 = _taggedTemplateLiteral(["<ods-icon icon-size=\"SM\" icon-name=\"", "\" color=\"\"></ods-icon>"])), icon || 'placeholder') : '');
       }
     }, {
       key: "render",
       value: function render() {
         return x(_templateObject4$1 || (_templateObject4$1 = _taggedTemplateLiteral(["\n            <style>\n            :host{\n                display: inline-flex;\n            }\n                *{\n                padding:0;\n                margin:0;\n                box-sizing:border-box;\n                } \n               .ods-link-wrapper {\n                    display: flex;\n                    align-items: center;\n                    a {\n                        display: flex;\n                        /* max-width: 250px; */\n                        word-break: break-word;\n                        align-items: start;\n                        outline: 2px solid transparent;\n                        gap: var(--ods-sem-space-sm);\n                        ods-text::part(odsText) {\n                            display:inline-block;\n                            text-decoration: underline;\n                            text-underline-position: under;\n                            color: var(--ods-sem-color-roles-primary);\n                        }\n                        ods-icon::part(odsIcon) {\n                            background-color: var(--ods-sem-color-roles-primary);\n                        }\n                        &:hover {\n                            ods-text::part(odsText) {\n                                color: var(--ods-sem-color-utility-states-primary-on-color-hover);\n                            }\n                            ods-icon {\n                                color: var(--ods-sem-color-utility-states-primary-on-color-hover);\n                                &::part(odsIcon) {\n                                    background-color: var(--ods-sem-color-utility-states-primary-on-color-hover);\n                                }\n                            }\n                        }\n                        &:focus-visible{\n                            outline: 2px solid var(--ods-sem-color-utility-states-primary-on-color-focus);\n                            outline-offset: 2px;\n                            border-radius: 5px;\n                        }\n                        &:active {\n                            ods-text::part(odsText) {\n                                color: var(--ods-sem-color-utility-states-primary-on-color-pressed);\n                            }\n                            ods-icon {\n                                color: var(--ods-sem-color-utility-states-primary-on-color-pressed);\n                                &::part(odsIcon) {\n                                    background-color: var(--ods-sem-color-utility-states-primary-on-color-pressed);\n                                }\n                            }\n                        }\n                    \n                    }\n                    .btn-link-sm ods-icon {\n                        margin-top: 3px;\n                    }\n                    .btn-link-md {\n                        /* font-size:16px; */\n                        ods-icon {\n                            margin-top: 5px;\n                        }\n                    }\n                    .btn-link-lg {\n                        /* font-size: 20px; */\n                        ods-icon {\n                            margin-top: 8px;\n                        }\n                    }\n                    \n                }\n               \n            </style>\n        ", "\n        "])), this.getAnchorTag());
       }
     }], [{
       key: "properties",
       get: function get() {
   ...
   var ODSRadio = /*#__PURE__*/function (_LitElement) {
     function ODSRadio() {
       var _this;
       _classCallCheck(this, ODSRadio);
       _this = _callSuper(this, ODSRadio);
       _this["input-name"] = '';
       _this.label = '';
       _this["is-selected"] = 'false';
       _this["hide-label"] = 'false';
       _this.NgApi = null;
       return _this;
     }
     _inherits(ODSRadio, _LitElement);
     return _createClass(ODSRadio, [{
       key: "connectedCallback",
       value: function connectedCallback() {
         _get(_getPrototypeOf(ODSRadio.prototype), "connectedCallback", this).call(this);
         this.NgApi = new OdsBridgeApi(this);
       }
     }, {
       key: "handleChange",
       value: function handleChange(e) {
         var el = this.shadowRoot.querySelector(".ods-radio-button");
         if (this["is-disabled"] === 'false') {
           this["is-selected"] = e.target.checked;
           this.dispatchEvent(new CustomEvent('change', {
             detail: this["is-selected"]
           }));
           this.NgApi.triggerNg(el.checked, e);
         }
       }
       ...
       key: "redirectClick",
       value: function redirectClick(e) {
         var _e$target$querySelect, _e$target$querySelect2;
         e.stopImmediatePropagation();
         (_e$target$querySelect = e.target.querySelector('.ods-radio-button')) === null || _e$target$querySelect === void 0 || _e$target$querySelect.click();
         (_e$target$querySelect2 = e.target.querySelector('.ods-radio-button')) === null || _e$target$querySelect2 === void 0 || _e$target$querySelect2.focus();
       }
     }, {
       key: "render",
       value: function render() {
         var isDisabled = this["is-disabled"] == 'true';
         var isChecked = this["is-selected"] == 'true';
         var isInvalid = this["is-invalid"] == 'true';
         var hideLabel = this["hide-label"] == 'true';
         return x(_templateObject$1 || (_templateObject$1 = _taggedTemplateLiteral(["\n    <style>\n    :host{\n      display:inline-flex;\n    }\n    * {\n    margin: var(--ods-sem-space-none);\n    padding: var(--ods-sem-space-none);\n    box-sizing:border-box;\n    }\n      .ods-radio-container {\n        display: flex;\n        padding: 10px 0;\n        justify-content: space-around;\n        \n        border-radius:var(--ods-sem-radius-sm);\n        position: relative;\n        outline: 2px solid transparent;\n        min-height: 44px;\n        min-width:44px;\n       gap: 12px;\n        &:focus-within{\n          display:inline-flex;\n          color: var(--ods-radio-container-hover-color);\n          outline:2px solid var(--ods-sem-color-roles-primary);\n          outline-offset: 2px;\n          border-radius:var(--ods-sem-radius-sm);\n          \n          outline: none;\n        }\n      }\n      .ods-radio-button {\n        display: inline-flex;\n        align-items: center;\n        min-width: var(--ods-sem-space-lg);\n        height: var(--ods-sem-space-lg);\n        border: 1px solid var(--ods-sem-color-roles-primary);\n        border-radius: var(--ods-sem-radius-full);\n        transition: border-color 0.3s ease, background-color 0.3s ease;\n        -webkit-appearance: none;\n        -moz-appearance: none;\n        appearance: none;\n        background-color:var(--ods-sem-color-roles-primary-on-primary);\n        position: relative;\n        z-index: 1;\n        &:focus-within {\n          outline: none;\n        }\n      }\n      .ods-radio-button:focus {\n        box-shadow:var(--ods-sem-color-utility-states-primary-on-color-focus);\n        background-color: var(--ods-sem-color-status-roles-error-on-error);\n        outline: none;\n      }\n      .ods-radio-button:hover, .ods-radio-container:hover .ods-radio-button {\n        background-color: var(--ods-sem-color-utility-states-primary-hover);\n        border-color: var(--ods-sem-color-utility-states-primary-on-color-hover);\n        cursor:  ", ";\n      }\n    \n      .ods-radio-container:active  .ods-radio-button{\n        background-color: var(--ods-sem-color-utility-states-primary-pressed);\n        border-color: var(--ods-sem-color-utility-states-primary-on-color-pressed);\n      }\n      .ods-radio-container {\n         cursor: pointer;\n      }\n      .ods-radio-container.readonly {\n        opacity: 0.5;\n         cursor: not-allowed;\n      }\n\n      .readonly .ods-radio-button {\n        opacity: 0.5;\n        background-color: var(--ods-sem-color-utility-states-disabled-container) !important;\n        border: 1px solid var(--ods-sem-color-utility-states-disabled-content) !important;\n      }\n      .ods-radio-label {\n        display: ", ";\n        align-items: center;\n        opacity: ", ";\n        word-break: break-word;\n        white-space: normal;\n        overflow: hidden;\n        text-overflow: ellipsis;\n        color: ", ";\n        cursor:  ", ";\n      }\n      .ods-radio-container:focus-within {\n        color: var(--ods-radio-container-hover-color);\n        outline: 2px solid var(--ods-sem-color-roles-primary);\n\n        ", ";\n        ", ";\n        .ods-radio-button{\n          outline: none;\n          ", ";\n        }\n      }\n      .ods-radio-button:checked::after {\n        content: '';\n        display: block;\n        width: 14px;\n        height: 14px;\n        margin: 4px;\n        border: 1px solid var(-ods-sem-color-roles-primary);\n        border-radius: var(--ods-sem-radius-full);\n        background-color: var(--ods-sem-color-roles-primary);\n      }\n      .ods-radio-button:checked.readonly::after {\n        content: '';\n        cursor:  ", ";\n        display: block;\n        width: 14px;\n        height: 14px;\n        margin: 4px;\n        border: 1px solid var(--ods-sem-color-utility-states-disabled-container) !important;\n        border-radius: var(--ods-sem-radius-full);\n        background-color: var(--ods-sem-color-utility-states-disabled-container) !important;\n      }\n      .error .ods-radio-container {\n        border-color: var(--ods-sem-color-utility-states-error-on-color-default);\n      }\n      .error .ods-radio-button {\n        border: 1px solid var(--ods-sem-color-utility-states-error-on-color-default);\n      }\n      .error .ods-radio-button:checked::after {\n        background-color: var(--ods-sem-color-status-roles-error);\n      }\n      .error .ods-radio-button:focus {\n        border-color: var(--ods-sem-color-utility-states-error-on-color-focus);\n        box-shadow:var(--ods-sem-color-status-roles-error-container);\n      }\n      .error:hover .ods-radio-button {\n        background-color: var(--ods-sem-color-status-roles-error-container);\n        border: 1px solid var(--ods-sem-color-utility-states-error-on-color-hover);\n      }\n      .error:active .ods-radio-button {\n        background-color: var(--ods-sem-color-status-roles-error-container);\n        border-color: var(--ods-sem-color-utility-states-error-on-color-pressed);\n      }\n      .readonly.error .ods-radio-button {\n        border-color: var(--ods-sem-color-utility-states-disabled-content) !important;\n      }\n      .readonly.error .ods-radio-button:checked::after {\n        background-color: var(--ods-sem-color-utility-states-disabled-content) !important;\n      }\n        \n      .readonly .ods-radio-button:checked::after {\n        background-color: var(--ods-sem-color-utility-states-disabled-content) !important;\n      }\n      .ods-radio-container.error:hover .ods-radio-button:checked::after {\n        background-color: var(--ods-sem-color-utility-states-error-on-color-hover);\n      }\n      .ods-radio-container.error:active .ods-radio-button:checked::after {\n        background-color: var(--ods-sem-color-utility-states-error-on-color-pressed);\n      }\n      .ods-radio-container:hover .ods-radio-button:checked::after {\n        background-color: var(--ods-sem-color-utility-states-primary-on-color-hover);\n      }\n      .ods-radio-container:active .ods-radio-button:checked::after {\n        background-color: var(--ods-sem-color-utility-states-primary-on-color-pressed);\n      }\n      .error .ods-radio-button:checked::after {\n        background-color: var(--ods-sem-color-status-roles-error);\n      }\n      </style>\n      <div class=\"ods-radio-container ", " ", "\" @click=\"", "\">\n      <input\n        class=\"ods-radio-button ", "\"\n        type=\"radio\" id=\"test-radio\"\n        .checked=\"", "\"\n        aria-disabled=\"", "\"\n        @change=\"", "\"\n        .disabled=\"", "\"\n        ", "\n        ", "\n      />\n      <label for=\"test-radio\" class=\"ods-radio-label\">\n      <ods-text class=\"label-text\" html-tag=\"span\" text-size=\"md\" weight=\"regular\" color=\"text-primary\">\n      ", "\n      </ods-text>\n      </label>\n    </div>\n    "])), isDisabled ? 'not-allowed' : 'pointer', hideLabel ? 'none' : 'flex', isDisabled ? '0.5' : '', isDisabled ? 'var(--ods-sem-color-utility-states-disabled-content)' : 'var(--ods-sem-color-text-primary)', isDisabled ? 'not-allowed' : 'pointer', hideLabel ? 'border-radius: var(--ods-sem-radius-full);' : '', isDisabled ? 'border: none; box-shadow: none;' : '', hideLabel ? ' margin-right:0px;' : '', isDisabled ? 'not-allowed' : 'pointer', isDisabled ? 'readonly' : '', isInvalid ? 'error' : '', this.redirectClick, isInvalid ? 'error' : '', isChecked, this["is-disabled"], this.handleChange, this["is-disabled"] == 'true', isChecked ? 'checked' : '', isInvalid ? 'error' : '', this.label);
       }
     }], [{
       key: "properties",
       get: function get() {
   ...
   customElements.define('ods-radio', ODSRadio);
 
   var _templateObject, _templateObject2, _templateObject3, _templateObject4, _templateObject5, _templateObject6, _templateObject7, _templateObject8, _templateObject9, _templateObject10, _templateObject11, _templateObject12, _templateObject13, _templateObject14;
   var OdsComboBox = /*#__PURE__*/function (_LitElement) {
     function OdsComboBox() {
       var _this;
       _classCallCheck(this, OdsComboBox);
       _this = _callSuper(this, OdsComboBox);
       _defineProperty(_this, "handleOutsideClick", function (event) {
         var container = _this.shadowRoot.querySelector('.selected-chips-container');
         if (container && !container.contains(event.target)) {
           ...
           _this.isOpened = false;
           _this.filteredOptions = _toConsumableArray(_this.options);
         }
         var input = _this.inputRef.value.querySelector("input");
         var inputValue = input.value.trim();
         if (!_this.options.some(function (option) {
           return option.text === inputValue;
         })) {
           if (_this["is-multiple"] == 'true') {
             input.value = '';
             _this.selectedValues = _this.selectedValues.filter(function (v) {
         ...
         _this.isOpened = false;
         _this.filteredOptions = _toConsumableArray(_this.options);
         _this._menu = _this.getDropdownMenu();
       });
       _this.width = "280px";
       _this["error-text"] = "";
       _this.tooltip = "";
       ...
       _this._menu = null;
       _this.inputRef = e();
       _this["no-results"] = "No Results found";
       _this.NgApi = null;
       return _this;
     }
     _inherits(OdsComboBox, _LitElement);
     return _createClass(OdsComboBox, [{
       key: "connectedCallback",
       value: function connectedCallback() {
         _get(_getPrototypeOf(OdsComboBox.prototype), "connectedCallback", this).call(this);
         this.NgApi = new OdsBridgeApi(this);
       ...
       key: "disconnectedCallback",
       value: function disconnectedCallback() {
         _get(_getPrototypeOf(OdsComboBox.prototype), "disconnectedCallback", this).call(this);
       ...
       value: function handleItemClick(e) {
         ...
         if (this["is-multiple"] == 'true') {
           var isSelected = this.selectedValues.some(function (selected) {
             return selected.value === value;
           });
           this.inputRef.value.querySelector("input").value = '';
           if (isSelected) {
             this.selectedValues = this.selectedValues.filter(function (item) {
               return item.value !== value;
             });
           } else {
             this.selectedValues = [].concat(_toConsumableArray(this.selectedValues), [{
               value: value,
               text: option.text
             }]);
           }
           ...
           this.inputRef.value.querySelector("input").value = option.text;
           this.inputRef.value.querySelector("input").focus();
         }
         this.isOpened = false;
         ...
         this.NgApi.triggerNg(value.value, e);
         (_this$shadowRoot$quer = this.shadowRoot.querySelector("ods-menu")) === null || _this$shadowRoot$quer === void 0 || _this$shadowRoot$quer.setMenuPosition();
       }
     }, {
       key: "handleSearch",
       value: function () {
         var _handleSearch = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(e) {
           var searchText;
           return _regeneratorRuntime().wrap(function _callee$(_context) {
             while (1) switch (_context.prev = _context.next) {
               case 0:
                 ...
                 if (searchText === "") {
                   this.filteredOptions = _toConsumableArray(this.options);
                 } else {
                   this.filteredOptions = this.options.filter(function (option) {
                     return option.text.toLowerCase().startsWith(searchText);
                   });
                 }
                 this._menu = this.getDropdownMenu();
               case 3:
       ...
       key: "handleKeyEsc",
       value: function handleKeyEsc(e) {
         if (e.key === 'Escape') {
           var input = this.inputRef.value.querySelector("input");
           input.focus();
         }
       }
     }, {
       ...
       value: function handleKeyDown(e) {
         ...
         if (e.key === 'Backspace' && this.inputRef.value.querySelector("input").value === '') {
           var lastSelectedValue = this.selectedValues[this.selectedValues.length - 1];
           if (lastSelectedValue) {
             this.removeOption(lastSelectedValue);
           }
           e.preventDefault();
         } else if (e.key === 'Backspace' && this["is-multiple"] != 'true') {
           this.selectedValues = [];
         } else if (e.key === 'Enter') {
           var _input = this.inputRef.value.querySelector("input");
           var inputValue = _input.value.trim();
       ...
       key: "resetMenuSelections",
       value: function resetMenuSelections() {
         var menuItems = Array.from(this.shadowRoot.querySelectorAll('ods-menu-item'));
       ...
       value: function removeOption(value) {
         var _this$shadowRoot$quer2;
         this.selectedValues = this.selectedValues.filter(function (v) {
           return v !== value;
         });
         if (this.selectedValues.length === 1 && this["is-multiple"] != 'true') {
           this.inputRef.value.value = this.selectedValues[0].text;
         } else {
           this.inputRef.value.value = '';
         }
         this.filteredOptions = this.options;
         this._menu = this.getDropdownMenu();
         (_this$shadowRoot$quer2 = this.shadowRoot.querySelector("ods-menu")) === null || _this$shadowRoot$quer2 === void 0 || _this$shadowRoot$quer2.setMenuPosition();
         this.hidePlaceholder = this.selectedValues.length > 0;
       }
     }, {
       key: "getInputField",
       value: function getInputField() {
         ...
         var selectedChips = this["is-multiple"] == 'true' ? this.selectedValues.map(function (selected) {
           return x(_templateObject || (_templateObject = _taggedTemplateLiteral(["\n          <ods-chip tabindex=\"-1\" @click=\"", "\">\n              <ods-text slot=\"label\" color=\"text-primary\">", "</ods-text>\n              <ods-icon slot=\"end\" icon-size=\"SM\" icon-name=\"close\" color=\"text-primary\" ></ods-icon>\n          </ods-chip>"])), function () {
             _this2.removeOption(selected);
           }, selected.text);
         }) : null;
         var inputValue = this["is-multiple"] == 'true' ? '' : this.selectedValues.length === 1 ? this.selectedValues[0].text : '';
         var placeholderText = inputValue === '' ? this["placeholder-text"] : '';
         if (this["is-multiple"] == 'true') {
           return x(_templateObject2 || (_templateObject2 = _taggedTemplateLiteral(["\n    <div class=\"selected-chips-container\" ", " @ods-active-menu-event=", " @click=", " > \n      <div class=\"selected-chips\">\n        ", "\n        <input\n        size= \"1\"\n        tabindex=\"0\"\n        type=\"", "\"\n        class=\"ods-form-control\"\n        id=\"", "\"\n        name=\"", "\"\n        placeholder=\"", "\"\n        error=\"", "\"\n        aria-describedby=\"", "\"\n        value=\"", "\"\n        aria-disabled=\"", "\"\n        .disabled=\"", "\"\n        ?required=\"", "\"\n        ?optional=\"", "\"\n        aria-invalid=\"", "\"\n        anchor=\"", "\"\n        @input=\"", "\"\n        @keydown=\"", "\"\n        autocomplete=\"off\"\n        />\n      </div>\n      <div class=\"ods-chevron-container\">    \n            <ods-icon\n                icon-size=\"SM\"\n                icon-name=\"chevron-down\"\n                color=\"\"\n              ></ods-icon>\n        </div>\n    </div>\n       "])), n(this.inputRef), this._handleSetActiveMenu, this.handleContainerClick, selectedChips, this["input-type"], this["form-name"], this["form-name"], this.hidePlaceholder ? "" : this["placeholder-text"], this["error-text"], this["form-name"], inputValue, this["is-disabled"], this["is-disabled"] == 'true', isRequired, isOptional, errorAlert, this["form-name"], this.handleSearch, this.handleKeyDown);
         }
         if (this["is-multiple"] === "false") {
           return x(_templateObject3 || (_templateObject3 = _taggedTemplateLiteral(["\n      <div class=\"selected-chips-container\" ", " @ods-active-menu-event=", " @click=", "> \n        <div class=\"selected-chips\">\n          ", "\n          <input\n          size= \"1\"\n          tabindex=\"0\"\n          type=\"", "\"\n          class=\"ods-form-control\"\n          id=\"", "\"\n          name=\"", "\"\n          placeholder=\"", "\"\n          error=\"", "\"\n          aria-describedby=\"", "\"\n          value=\"", "\"\n          aria-disabled=\"", "\"\n          .disabled=\"", "\"\n          ?required=\"", "\"\n          ?optional=\"", "\"\n          aria-invalid=\"", "\"\n          anchor=\"", "\"\n          @input=\"", "\"\n          @keydown=\"", "\"\n          autocomplete=\"off\"\n          />\n        </div>\n        <div class=\"ods-chevron-container\">    \n              <ods-icon\n                  icon-size=\"SM\"\n                  icon-name=\"chevron-down\"\n                  color=\"\"\n                ></ods-icon>\n          </div>\n      </div>\n         "])), n(this.inputRef), this._handleSetActiveMenu, this.handleContainerClick, selectedChips, this["input-type"], this["form-name"], this["form-name"], placeholderText, this["error-text"], this["form-name"], inputValue, this["is-disabled"], this["is-disabled"] == 'true', isRequired, isOptional, errorAlert, this["form-name"], this.handleSearch, this.handleKeyDown);
         }
       }
     }, {
       key: "_handleSetActiveMenu",
       ...
       value: function getInfoIcon() {
         if (this.tooltip != "") {
           return x(_templateObject5 || (_templateObject5 = _taggedTemplateLiteral(["\n        <div class=\"ods-button\">\n          <button tabindex=\"", "\" class=\"btn-ghost\" aria-describedby=\"tooltip\" .disabled=\"", "\"\n          >\n            <ods-icon icon-size=\"SM\" icon-name=\"info\" color=\"\"> </ods-icon>\n          </button>\n          <ods-tooltip id=\"tooltip\" label=\"", "\" ></ods-tooltip>\n        </div>\n      "])), this["is-disabled"] == 'true' ? '-1' : '1', this["is-disabled"] == 'true', this.tooltip);
         }
       }
     }, {
       key: "getLabelField",
       ...
       value: function getLabelText() {
         var labelText = this.label;
         if (this["is-required"] == 'true') {
           labelText = x(_templateObject7 || (_templateObject7 = _taggedTemplateLiteral(["", "<ods-text\n          class=\"left-spacing\"\n          html-tag=\"span\"\n          text-size=\"sm\"\n          weight=\"regular\"\n          color=\"text-primary\"\n        >\n          (required)\n        </ods-text>"])), labelText);
         }
         if (this["is-required"] != "true" && this["is-optional"] == 'true') {
           labelText = x(_templateObject8 || (_templateObject8 = _taggedTemplateLiteral(["", "<ods-text\n          class=\"left-spacing\"\n          html-tag=\"span\"\n          text-size=\"sm\"\n          weight=\"regular\"\n          color=\"text-primary\"\n          >(optional)</ods-text\n        >"])), labelText);
         }
         return labelText;
       }
     }, {
       ...
       value: function getOptions() {
         var _this3 = this;
         var selectedValues = this.selectedValues.map(function (values) {
           return values.value;
         });
         return this.filteredOptions.map(function (option) {
           var SlotStart = option.avatar ? x(_templateObject9 || (_templateObject9 = _taggedTemplateLiteral(["\n    <ods-avatar\n    avatar-size=\"MD\"\n    user-name=\"", "\"\n    icon=\"", "\"\n    image=\"", "\"\n    slot=\"start\">\n  </ods-avatar>"])), option.avatar.name ? option.avatar.name : '', option.avatar.icon ? option.avatar.icon : '', option.avatar.image || '') : option.icon ? x(_templateObject10 || (_templateObject10 = _taggedTemplateLiteral(["<ods-icon icon-name=\"", "\" slot=\"start\"></ods-icon>"])), option.icon) : '';
           return x(_templateObject11 || (_templateObject11 = _taggedTemplateLiteral(["\n        <ods-menu-item\n        @keydown=\"", "\"\n        value=\"", "\"\n        @menu-item-click-event=\"", "\"\n        is-selected=", "\n      >\n        <ods-text text-size=\"sm\" color=\"text-primary\" slot=\"label\">", "</ods-text>\n        <ods-text text-size=\"sm\" color=\"text-primary\" slot=\"sub-label\">", "</ods-text>\n        ", "\n      </ods-menu-item>\n        "])), _this3.handleKeyEsc, option.value, _this3.handleItemClick, selectedValues.includes(option.value), option.text, option.subText, SlotStart);
         });
       }
     }, {
       key: "getDropdownMenu",
       value: function getDropdownMenu() {
         if (this["is-multiple"] === "false") {
           return x(_templateObject12 || (_templateObject12 = _taggedTemplateLiteral(["<ods-menu\n      @menu-toggle-event=\"", "\"\n      max-width=\"184px\"\n      max-height=\"266px\"\n      match-width=\"true\"\n      anchor=\"buttonWithStart\"\n      selectable\n      single-select\n      .elRef=", "\n      allow-write\n      no-items-label=\"", "\"\n    >\n    ", "\n    </ods-menu>"])), this.handleSelectClick, this.inputRef.value, this["no-results"], this.getOptions());
         } else if (this["is-multiple"] == 'true') {
           return x(_templateObject13 || (_templateObject13 = _taggedTemplateLiteral(["<ods-menu\n    @menu-toggle-event=\"", "\"\n    max-width=\"184px\"\n    max-height=\"266px\"\n    match-width=\"true\"\n    anchor=\"buttonWithStart\"\n    selectable\n    .elRef=", "\n    allow-write\n    no-close-on-select\n    no-items-label=\"", "\"\n  >\n    ", "\n  </ods-menu>"])), this.handleSelectClick, this.inputRef.value, this["no-results"], this.getOptions());
         }
       }
     }, {
       key: "firstUpdated",
       value: function firstUpdated() {
         ...
         var elValue = this.NgApi.getNgModelValue();
         if (elValue) {
           this.inputRef.value.querySelector("input").value = elValue;
         }
       }
     }, {
       key: "createRenderRoot",
       ...
       value: function render() {
         ...
         if (this.isOpened) ;
         return x(_templateObject14 || (_templateObject14 = _taggedTemplateLiteral(["\n      <style>\n      :host{\n          ", "\n          position: relative;\n        }\n        * {\n          box-sizng: border-box;\n          margin: var(--ods-sem-space-none);\n          padding: var(--ods-sem-space-none);\n        }\n        \n        input{\n          min-width: 0;\n        }\n         input:focus{\n          min-width: 60px;         \n        } \n\n\n        .selected-chips-container{\n          display: flex;\n          padding: 6px 16px;\n          background-color: var(--ods-sem-color-background-primary);\n          background-clip: padding-box;\n          box-shadow: 0 0 0 1px var(--ods-sem-color-border-interactive-component);\n          border-width: 0;\n          -webkit-appearance: none;\n          -moz-appearance: none;\n          appearance: none;\n          border-radius: var(--ods-sem-radius-sm);\n          display: flex;\n          flex-wrap: wrap;\n          align-items: center;\n          cursor: pointer;          \n        }\n\n        .selected-chips{\n          display: inline-flex;\n          min-height: 32px;  \n          flex: 1;\n          gap: var(--ods-sem-space-sm);\n          flex-wrap: wrap;\n          pointer-events: all;\n          ods-icon{\n            pointer-events: all;\n          }\n        }\n\n         .ods-chevron-container{\n          pointer-events: none;\n          display:flex;\n          self-align: right;\n          align-items: center;\n          justify-content: flex-end;\n          padding: var(--ods-sem-space-sm);\n        }\n\n        .ods-chevron-container ods-icon {\n          transition: transform 0.2s ease-in-out;\n          transform: rotateZ(-0deg);\n        }\n\n        [active-menu] .ods-chevron-container ods-icon{\n          transform: rotateZ(-180deg);\n        }\n\n        .selected-chips-container:focus-within{\n          color: var(--ods-sem-color-roles-neutral-on-neutral-container);\n              background-color: var(--ods-sem-color-background-primary);\n              box-shadow: 0 0 0 2px var(--ods-sem-color-utility-states-primary-on-color-focus) !important;\n              outline: 0;\n              ~ .ods-label-container ods-text::part(odsText) {\n                color: var(--ods-sem-color-utility-states-primary-on-color-focus) !important;\n              }\n            }\n        }\n\n        \n        .ods-form-label {\n          margin-bottom: var(--ods-sem-space-sm);\n          font-family: lato;\n          font-weight: 400;\n          font-size: 14px;\n          line-height: var(--ods-sem-space-lg);\n          margin: 0;\n          color: var(--ods-sem-color-text-primary);\n        }\n        \n\n        .ods-form-control {\n          flex: 1 1; \n          padding: 6px 0px;\n          font-size: var(--ods-sem-space-md);\n          font-family: lato, Helvetica, Arial, sans-serif;\n          font-weight:  400;\n          color: var(--ods-sem-color-roles-neutral-on-neutral-container);\n          background-color: var(--ods-sem-color-background-primary);\n          background-clip: padding-box;\n          border-width: var(--ods-sem-space-none);\n          -webkit-appearance: none;\n          -moz-appearance: none;\n          appearance: none;\n          outline: none;\n        }\n        \n\n        @media (prefers-reduced-motion: reduce) {\n          .ods-form-control {\n            transition: none;\n          }\n        }\n        .ods-form-control::-moz-placeholder {\n          color: var(--ods-sem-color-roles-neutral);\n          opacity: 1;\n        }\n        .ods-form-control::placeholder {\n          color: var(--ods-sem-color-roles-neutral);\n          opacity: 1;\n        }\n\n        .ods-field-container {\n          width: ", ";\n          display: flex;\n          flex-direction: column-reverse;\n          gap: var(--ods-sem-space-xs);\n          box-sizing: border-box;\n        }\n\n        .ods-label-container {\n          display: flex;\n          align-items: flex-start;\n          gap: var(--ods-sem-space-xs);\n        }\n\n        .ods-label-container ods-icon-button {\n          display: flex;\n          align-items: center;\n          justify-content: center;\n          --ods-icon-button-height: 24px;\n          --ods-icon-button-width: 24px;\n        }\n        .ods-button {\n          display: flex;\n          align-items: center;\n          justify-content: center;\n          --ods-icon-button-height: 24px;\n          --ods-icon-button-width: 24px;\n        }\n        ods-icon-button ods-icon::part(odsIcon) {\n          width: var(--ods-sem-icon-sm);\n          height: var(--ods-sem-icon-sm);\n        }\n        .ods-error-container {\n          width: ", ";\n          display: flex;\n          justify-content: flex-start;\n          gap: var(--ods-sem-space-sm);\n        }\n        .ods-error-container ods-icon {\n          display: flex;\n          align-items: center;\n          justify-content: center;\n          height: var(--ods-sem-space-md);\n          width: var(--ods-sem-space-md);\n          padding: 4px 0px;\n        }\n\n    .ods-field-container {\n          .ods-label-container {\n            &:hover {\n              color: var(--ods-sem-color-utility-states-primary-on-color-hover);\n              cursor: pointer;\n              label {\n              color: var(--ods-sem-color-utility-states-primary-on-color-hover);\n              cursor: pointer;\n              }\n            }\n        }\n            \n            .selected-chips-container:has(+ .ods-label-container:hover) {\n                border-width: 0;\n                box-shadow: 0 0 0 1px var(--ods-sem-color-roles-primary);\n                cursor: pointer;\n              }\n      }\n    \n\n        \n       .ods-field-container {\n          .selected-chips-container {\n            &:hover {\n              border-width: 0;\n              box-shadow: 0 0 0 1px var(--ods-sem-color-roles-primary);\n              ~ .ods-label-container ods-text::part(odsText) {\n                color: var(--ods-sem-color-utility-states-primary-on-color-hover);\n              }\n              ~ .ods-label-container label {\n                cursor: pointer;\n              }\n            }\n            &:focus{\n              color: var(--ods-sem-color-roles-neutral-on-neutral-container);\n              background-color: var(--ods-sem-color-background-primary);\n              box-shadow: 0 0 0 2px var(--ods-sem-color-utility-states-primary-on-color-focus);\n              border-width: 0;\n              outline: 0;\n              ~ .ods-label-container ods-text::part(odsText) {\n                color: var(--ods-sem-color-utility-states-primary-on-color-focus) !important;\n              }       \n            }\n            &:active {\n              box-shadow: 0 0 0 1px var(--ods-sem-color-utility-states-primary-on-color-pressed) !important;\n              ~ .ods-label-container ods-text::part(odsText) {\n                color: var(--ods-sem-color-utility-states-primary-on-color-pressed) !important;\n              }\n            }\n            &[active-menu] {\n              box-shadow: 0 0 0 1px var(--ods-sem-color-utility-states-primary-on-color-pressed);\n              ~ .ods-label-container ods-text::part(odsText) {\n                color: var(--ods-sem-color-utility-states-primary-on-color-pressed);\n              }\n            }\n          }\n          &.readonly {\n            opacity: 0.5;\n            cursor: not-allowed;\n            .selected-chips-container{\n              pointer-events: none;\n              color: var(--ods-sem-color-utility-states-disabled-content);\n              background-color: var(--ods-sem-color-utility-states-disabled-container);\n              background-clip: padding-box;\n              box-shadow: 0 0 0 1px var(--ods-sem-color-utility-states-disabled-content);\n              -webkit-appearance: none;\n              -moz-appearance: none;\n              appearance: none;\n              cursor: not-allowed;\n            }\n            .selected-chips{\n              pointer-events: none;\n            }\n            .ods-label-container ods-text::part(odsText) {\n              color: var(--ods-sem-color-utility-states-disabled-content);\n              pointer-events: none;\n            }\n             .ods-label-container ods-text::part(odsText) {\n              color: var(--ods-sem-color-utility-states-disabled-content);\n              pointer-events: none;\n            }\n            .ods-label-container, .ods-button {\n               pointer-events: none;\n            }\n            input{\n            color: var(--ods-sem-color-utility-states-disabled-content);\n            background-color: var(--ods-sem-color-utility-states-disabled-container);\n            pointer-events: none !important;\n            cursor: not-allowed !important;\n            }\n            &:focus-within{\n            .ods-label-container {\n              color: var(--ods-sem-color-utility-states-disabled-content);\n              pointer-events: none;\n              cursor: not-allowed;\n              cursor: pointer;\n              label {\n              color: var(--ods-sem-color-utility-states-disabled-content);\n              }\n          }\n            .selected-chips-container {\n              color: var(--ods-sem-color-utility-states-disabled-content);\n              background-color: var(--ods-sem-color-utility-states-disabled-container);\n              background-clip: padding-box;\n              box-shadow: 0 0 0 1px var(--ods-sem-color-utility-states-disabled-content) !important;\n              -webkit-appearance: none;\n              -moz-appearance: none;\n              appearance: none;\n              cursor: not-allowed;\n               pointer-events: none;\n              }\n            }\n        }\n          &.error-state {\n            .selected-chips-container {\n              box-shadow: 0 0 0 1px var(--ods-sem-color-utility-states-error-on-color-default);\n              border-width: 0;\n              ~ .ods-label-container ods-text::part(odsText) {\n                color: var(--ods-sem-color-status-roles-error);\n              }\n              &:hover {\n                box-shadow: 0 0 0 1px var(--ods-sem-color-utility-states-error-on-color-hover);\n                ~ .ods-label-container ods-text::part(odsText) {\n                  color: var(--ods-sem-color-utility-states-error-on-color-hover);\n                }\n              }\n              &:focus-within {\n              box-shadow: 0 0 0 2px var(--ods-sem-color-utility-states-error-on-color-focus) !important;\n              border-width: 0;\n              outline: 0;\n              ~ .ods-label-container ods-text::part(odsText) {\n                color: var(--ods-sem-color-status-roles-error);\n              }\n              }\n              &:active {\n                box-shadow: 0 0 0 1px var(--ods-sem-color-utility-states-error-on-color-pressed);\n                ~ .ods-label-container ods-text::part(odsText) {\n                  color: var(--ods-sem-color-utility-states-error-on-color-pressed);\n                }\n              }\n            }\n              .ods-label-container {\n            &:hover {\n              color: var(--ods-sem-color-utility-states-error-on-color-hover);\n              cursor: pointer;\n              label {\n              color: var(--ods-sem-color-utility-states-error-on-color-hover);\n              }\n            }\n        }\n            \n            .selected-chips-container:has(+ .ods-label-container:hover) {\n                box-shadow: 0 0 0 1px var(--ods-sem-color-utility-states-error-on-color-hover);\n                border-width: 0;\n              }\n          }\n        }\n\n        \n        ods-text::part(odsText) {\n          line-height: var(--ods-sem-space-lg);\n          word-break: break-word;\n        }\n        ods-text.left-spacing {\n          margin-left: var(--ods-sem-space-xs);\n        }\n        ods-text {\n          display: inline-block;\n        }\n    \n        button {\n          border-radius: var(--ods-sem-radius-full);\n          height: var(--ods-icon-button-height, 44px);\n          width: var(--ods-icon-button-width, 44px);\n          text-decoration: none;\n          border: var(--ods-sem-space-none);\n          cursor: pointer;\n          justify-content: center;\n          box-sizing: border-box;\n          display: inline-flex;\n          align-items: center;\n          padding: 0;\n        }\n        .btn-ghost {\n          color: var(--ods-sem-color-roles-primary);\n          background: transparent;\n        }\n        .btn-ghost:hover {\n          background: var(--ods-sem-color-utility-states-primary-hover);\n        }\n        .btn-ghost:focus {\n          outline: none;\n          box-shadow: 0 0 0 2px var(--ods-sem-color-roles-primary);\n        }\n        .btn-ghost:active {\n          background: var(--ods-sem-color-utility-states-primary-pressed);\n          box-shadow: none;\n        }\n        \n\n      </style>\n      <div class=", ">\n      ", "", " ", "\n      </div>\n      ", "\n    "])), this["full-width"] === "false" ? 'display: inline-flex;' : '', this["full-width"] === "false" ? this.width : '100%', this["full-width"] === "false" ? this.width : '100%', ["ods-field-container", isReadOnly, isError].join(" "), this.getErrorMessage(), this.getInputField(), this.getLabelField(), this._menu);
       }
     }], [{
       key: "properties",
       get: function get() {
   ...
   customElements.define("ods-combobox", OdsComboBox);
